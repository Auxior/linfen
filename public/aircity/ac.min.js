...
$jscomp.defineProperty=$jscomp.ASSUME_ES5||"function"==typeof Object.defineProperties?Object.defineProperty:function(v,E,C){if(v==Array.prototype||v==Object.prototype)return v;v[E]=C.value;return v};$jscomp.getGlobal=function(v){v=["object"==typeof globalThis&&globalThis,v,"object"==typeof window&&window,"object"==typeof self&&self,"object"==typeof global&&global];for(var E=0;E<v.length;++E){var C=v[E];if(C&&C.Math==Math)return C}throw Error("Cannot find global object");};$jscomp.global=$jscomp.getGlobal(this);
$jscomp.IS_SYMBOL_NATIVE="function"===typeof Symbol&&"symbol"===typeof Symbol("x");$jscomp.TRUST_ES6_POLYFILLS=!$jscomp.ISOLATE_POLYFILLS||$jscomp.IS_SYMBOL_NATIVE;$jscomp.polyfills={};$jscomp.propertyToPolyfillSymbol={};$jscomp.POLYFILL_PREFIX="$jscp$";var $jscomp$lookupPolyfilledValue=function(v,E){var C=$jscomp.propertyToPolyfillSymbol[E];if(null==C)return v[E];C=v[C];return void 0!==C?C:v[E]};
$jscomp.polyfill=function(v,E,C,K){E&&($jscomp.ISOLATE_POLYFILLS?$jscomp.polyfillIsolated(v,E,C,K):$jscomp.polyfillUnisolated(v,E,C,K))};$jscomp.polyfillUnisolated=function(v,E,C,K){C=$jscomp.global;v=v.split(".");for(K=0;K<v.length-1;K++){var O=v[K];if(!(O in C))return;C=C[O]}v=v[v.length-1];K=C[v];E=E(K);E!=K&&null!=E&&$jscomp.defineProperty(C,v,{configurable:!0,writable:!0,value:E})};
$jscomp.polyfillIsolated=function(v,E,C,K){var O=v.split(".");v=1===O.length;K=O[0];K=!v&&K in $jscomp.polyfills?$jscomp.polyfills:$jscomp.global;for(var F=0;F<O.length-1;F++){var I=O[F];if(!(I in K))return;K=K[I]}O=O[O.length-1];C=$jscomp.IS_SYMBOL_NATIVE&&"es6"===C?K[O]:null;E=E(C);null!=E&&(v?$jscomp.defineProperty($jscomp.polyfills,O,{configurable:!0,writable:!0,value:E}):E!==C&&(void 0===$jscomp.propertyToPolyfillSymbol[O]&&(C=1E9*Math.random()>>>0,$jscomp.propertyToPolyfillSymbol[O]=$jscomp.IS_SYMBOL_NATIVE?
$jscomp.global.Symbol(O):$jscomp.POLYFILL_PREFIX+C+"$"+O),$jscomp.defineProperty(K,$jscomp.propertyToPolyfillSymbol[O],{configurable:!0,writable:!0,value:E})))};$jscomp.initSymbol=function(){};$jscomp.iteratorPrototype=function(v){v={next:v};v[Symbol.iterator]=function(){return this};return v};$jscomp.underscoreProtoCanBeSet=function(){var v={a:!0},E={};try{return E.__proto__=v,E.a}catch(C){}return!1};
$jscomp.setPrototypeOf=$jscomp.TRUST_ES6_POLYFILLS&&"function"==typeof Object.setPrototypeOf?Object.setPrototypeOf:$jscomp.underscoreProtoCanBeSet()?function(v,E){v.__proto__=E;if(v.__proto__!==E)throw new TypeError(v+" is not extensible");return v}:null;$jscomp.makeIterator=function(v){var E="undefined"!=typeof Symbol&&Symbol.iterator&&v[Symbol.iterator];return E?E.call(v):$jscomp.arrayIterator(v)};$jscomp.generator={};
...
$jscomp.generator.Context.prototype.throw_=function(v){this.abruptCompletion_={exception:v,isException:!0};this.jumpToErrorHandler_()};$jscomp.generator.Context.prototype.return=function(v){this.abruptCompletion_={return:v};this.nextAddress=this.finallyAddress_};$jscomp.generator.Context.prototype.jumpThroughFinallyBlocks=function(v){this.abruptCompletion_={jumpTo:v};this.nextAddress=this.finallyAddress_};$jscomp.generator.Context.prototype.yield=function(v,E){this.nextAddress=E;return{value:v}};
$jscomp.generator.Context.prototype.yieldAll=function(v,E){v=$jscomp.makeIterator(v);var C=v.next();$jscomp.generator.ensureIteratorResultIsObject_(C);if(C.done)this.yieldResult=C.value,this.nextAddress=E;else return this.yieldAllIterator_=v,this.yield(C.value,E)};$jscomp.generator.Context.prototype.jumpTo=function(v){this.nextAddress=v};$jscomp.generator.Context.prototype.jumpToEnd=function(){this.nextAddress=0};
$jscomp.generator.Context.prototype.setCatchFinallyBlocks=function(v,E){this.catchAddress_=v;void 0!=E&&(this.finallyAddress_=E)};$jscomp.generator.Context.prototype.setFinallyBlock=function(v){this.catchAddress_=0;this.finallyAddress_=v||0};$jscomp.generator.Context.prototype.leaveTryBlock=function(v,E){this.nextAddress=v;this.catchAddress_=E||0};
$jscomp.generator.Context.prototype.enterCatchBlock=function(v){this.catchAddress_=v||0;v=this.abruptCompletion_.exception;this.abruptCompletion_=null;return v};$jscomp.generator.Context.prototype.enterFinallyBlock=function(v,E,C){C?this.finallyContexts_[C]=this.abruptCompletion_:this.finallyContexts_=[this.abruptCompletion_];this.catchAddress_=v||0;this.finallyAddress_=E||0};
$jscomp.generator.Context.prototype.leaveFinallyBlock=function(v,E){E=this.finallyContexts_.splice(E||0)[0];if(E=this.abruptCompletion_=this.abruptCompletion_||E){if(E.isException)return this.jumpToErrorHandler_();void 0!=E.jumpTo&&this.finallyAddress_<E.jumpTo?(this.nextAddress=E.jumpTo,this.abruptCompletion_=null):this.nextAddress=this.finallyAddress_}else this.nextAddress=v};$jscomp.generator.Context.prototype.forIn=function(v){return new $jscomp.generator.Context.PropertyIterator(v)};
$jscomp.generator.Context.PropertyIterator=function(v){this.object_=v;this.properties_=[];for(var E in v)this.properties_.push(E);this.properties_.reverse()};$jscomp.generator.Context.PropertyIterator.prototype.getNext=function(){for(;0<this.properties_.length;){var v=this.properties_.pop();if(v in this.object_)return v}return null};$jscomp.generator.Engine_=function(v){this.context_=new $jscomp.generator.Context;this.program_=v};
...
$jscomp.generator.Engine_.prototype.return_=function(v){this.context_.start_();var E=this.context_.yieldAllIterator_;if(E)return this.yieldAllStep_("return"in E?E["return"]:function(C){return{value:C,done:!0}},v,this.context_.return);this.context_.return(v);return this.nextStep_()};
...
$jscomp.generator.Engine_.prototype.yieldAllStep_=function(v,E,C){try{var K=v.call(this.context_.yieldAllIterator_,E);$jscomp.generator.ensureIteratorResultIsObject_(K);if(!K.done)return this.context_.stop_(),K;var O=K.value}catch(F){return this.context_.yieldAllIterator_=null,this.context_.throw_(F),this.nextStep_()}this.context_.yieldAllIterator_=null;C.call(this.context_,O);return this.nextStep_()};
$jscomp.generator.Engine_.prototype.nextStep_=function(){for(;this.context_.nextAddress;)try{var v=this.program_(this.context_);if(v)return this.context_.stop_(),{value:v.value,done:!1}}catch(E){this.context_.yieldResult=void 0,this.context_.throw_(E)}this.context_.stop_();if(this.context_.abruptCompletion_){v=this.context_.abruptCompletion_;this.context_.abruptCompletion_=null;if(v.isException)throw v.exception;return{value:v.return,done:!0}}return{value:void 0,done:!0}};
$jscomp.generator.Generator_=function(v){this.next=function(E){return v.next_(E)};this.throw=function(E){return v.throw_(E)};this.return=function(E){return v.return_(E)};this[Symbol.iterator]=function(){return this}};$jscomp.generator.createGenerator=function(v,E){E=new $jscomp.generator.Generator_(new $jscomp.generator.Engine_(E));$jscomp.setPrototypeOf&&v.prototype&&$jscomp.setPrototypeOf(E,v.prototype);return E};
$jscomp.asyncExecutePromiseGenerator=function(v){function E(K){return v.next(K)}function C(K){return v.throw(K)}return new Promise(function(K,O){function F(I){I.done?K(I.value):Promise.resolve(I.value).then(E,C).then(F,O)}F(v.next())})};$jscomp.asyncExecutePromiseGeneratorFunction=function(v){return $jscomp.asyncExecutePromiseGenerator(v())};$jscomp.asyncExecutePromiseGeneratorProgram=function(v){return $jscomp.asyncExecutePromiseGenerator(new $jscomp.generator.Generator_(new $jscomp.generator.Engine_(v)))};
$jscomp.polyfill("Array.prototype.includes",function(v){return v?v:function(E,C){var K=this;K instanceof String&&(K=String(K));var O=K.length;C=C||0;for(0>C&&(C=Math.max(C+O,0));C<O;C++){var F=K[C];if(F===E||Object.is(F,E))return!0}return!1}},"es7","es3");$jscomp.polyfill("Promise.prototype.finally",function(v){return v?v:function(E){return this.then(function(C){return Promise.resolve(E()).then(function(){return C})},function(C){return Promise.resolve(E()).then(function(){throw C;})})}},"es9","es3");
var acapi=function(v){function E(a){function b(c,e){return c.reduce(function(d,g){var h;Array.isArray(g)&&(h=b(g,e+1));return h>d?h:d},e)}return b(a,1)}function C(a){if(void 0!=a){var b=[];if(/^(rgb|RGB)/.test(a)){a=a.replace(/(?:\(|\)|rgb|RGB)*/g,"").split(",");for(var c of a)b.push(Number((Number(c)/255).toFixed(6)))}else/^#/.test(a)?(a=a.replace("#",""),6!=a.length?(console.error("\u975e\u5341\u516d\u8fdb\u5236\u989c\u8272\u683c\u5f0f"),b=void 0):(b=parseInt(a.substring(0,2),16),c=parseInt(a.substring(2,
4),16),a=parseInt(a.substring(4,6),16),b=[b/255,c/255,a/255])):a instanceof Array&&(b=a);3==b.length&&b.push(1);return b}}function K(a){if(void 0!=a){var b,c=E(a);2==c?b=[[a]]:3==c?b=[a]:4==c&&(b=a);if(b)for(let e of b)for(let d of e)for(let g of d)2==g.length&&g.push(0);return b}}function O(a){if(void 0!=a)return 1==E(a)?[a]:a}function F(a){return a instanceof Array?a:[a]}function I(a){let b=[];if(a instanceof Array)for(let c in a)b[c]=a[c].toString();else b=[a.toString()];return b}function S(a){switch(typeof a){case "undefined":return!0;
case "string":if(0===a.replace(/(^[ \t\n\r]*)|([ \t\n\r]*$)/g,"").length)return!0;break;case "boolean":if(!a)return!0;break;case "number":if(isNaN(a))return!0;break;case "object":if(null===a||0===a.length)return!0;for(var b in a)return!1;return!0}return!1}function qa(a,b){for(a=a.toString();a.length<b;)a="0"+a;return a}function ta(){let a=new Date;return qa(a.getHours(),2)+":"+qa(a.getMinutes(),2)+":"+qa(a.getSeconds(),2)+"."+qa(a.getMilliseconds(),3)}function Ia(a,b){let c,e=0;return function(...d){const g=
this,h=+new Date,q=b-(h-e);0>=q?(e=h,a.apply(g,d),c&&(clearTimeout(c),c=null)):c||(c=setTimeout(()=>{e=+new Date;c=null;a.apply(g,d)},q))}}function Ja(a){switch(a){case da.StartingProcess:return"starting process...";case da.CheckingBusy:return"checking...";case da.ProcessStartFailed:return"process start failed!";case da.ProcessStarted:return"process started";case da.LoadingProject:return"loading project...";case da.ProjectLoaded:return"project loaded"}}function xa(a){"string"===typeof a&&(a=document.getElementById(a));
return a}function Ka(a){return R.isIOSDevice&&R.isInWeixinBrowser?!1:a==ka.abnormal||a==ka.instance_disconnected}function W(a,b){return void 0!==a&&null!==a?a:b}function V(){if(!(this instanceof V))return new V;this.reg=Array(8);this.chunk=[];this.size=0;this.reset()}function La(a){var b=new V;a=b.sum(a);return b.toArray(a,function(c){return("0"+(c&255).toString(16)).slice(-2)}).join("")}function ya(a){return a.keyCode===ea.Shift&&"ShiftRight"===a.code?ea.RightShift:a.keyCode===ea.Control&&"ControlRight"===
a.code?ea.RightControl:a.keyCode===ea.Alt&&"AltRight"===a.code?ea.RightAlt:a.keyCode}var p={None:0,Camera_PlayAnimation:1,Camera_StopAnimation:2,Misc_EnterReportMode:3,Misc_ExitReportMode:4,Misc_SetDateTime:5,Camera_GetCamera:6,Camera_SetState:7,Camera_Set:8,Camera_LookAtBBox:9,Coord_World2Screen:10,Coord_Screen2World:11,InfoTree_SetVisibility:12,InfoTree_Show:13,InfoTree_Hide:14,InfoTree_EnableXRay:15,InfoTree_DisableXRay:16,TileLayer_Add:17,HeatMap_Add:18,HeatMap_Update:19,HeatMap_AddPoints:20,
HeatMap_RemovePoints:21,HeatMap_Delete:22,HeatMap_Show:23,HeatMap_Hide:24,HeatMap_Focus:25,HighlightArea_Add:26,HighlightArea_Delete:27,HighlightArea_Update:28,Polygon3D_Add:29,Polygon3D_Delete:30,Misc_AddImageButton:31,Misc_DeleteImageButton:32,Misc_AddAnimatedImageButton:33,Settings_SetMainUIVisibility:34,Settings_SetMousePickMask:35,Tag_Add:36,Tag_Delete:37,Tag_Update:38,Tag_Clear:39,Tag_Focus:40,Beam_Add:41,Beam_Update:42,Beam_Delete:43,Beam_Clear:44,Beam_Focus:45,Beam_Show:350,Beam_Hide:351,
Beam_ShowAll:352,Beam_HideAll:353,RadiationPoint_Add:46,RadiationPoint_Update:47,RadiationPoint_Delete:48,RadiationPoint_Clear:49,Polygon_Add:50,Polygon_Update:51,Polygon_Delete:52,Polygon_Clear:53,Polygon_Highlight:54,Polygon_StopHighlight:325,Polygon_Glow:55,Polygon_Focus:56,Tag_FocusAll:57,Tag_Show:58,Tag_Hide:59,Tag_ShowAll:60,Tag_HideAll:61,RadiationPoint_Focus:62,RadiationPoint_FocusAll:63,RadiationPoint_Show:64,RadiationPoint_Hide:65,RadiationPoint_ShowAll:66,RadiationPoint_HideAll:67,Polygon_Show:68,
Polygon_Hide:69,Polygon3D_Update:70,Polygon3D_Clear:71,Polygon3D_Focus:72,Polygon3D_Show:73,Polygon3D_Hide:74,Polygon3D_Highlight:75,Polygon3D_Glow:76,Polygon3D_StopGlow:77,HighlightArea_Clear:78,HighlightArea_Focus:79,HighlightArea_Show:80,HighlightArea_Hide:81,Misc_GetVersion:82,TileLayer_Update:83,TileLayer_Delete:84,TileLayer_Focus:85,TileLayer_EnableXRay:86,TileLayer_DisableXRay:87,TileLayer_Show:88,TileLayer_Hide:89,Tag_Get:90,RadiationPoint_Get:91,Polygon_Get:92,Polygon3D_Get:93,HighlightArea_Get:94,
TileLayer_Get:95,Beam_Get:96,HeatMap_Get:97,Settings_GetMapMode:98,Settings_SetMapMode:99,Settings_SetMapURL:100,Settings_SetWMTSLayerVisible:320,TileLayer_Actor_Show:101,TileLayer_Actor_Hide:102,TileLayer_Actor_Focus:103,TileLayer_Actor_Highlight:104,TileLayer_Actor_StopHightlight:105,CustomObject_Add:106,CustomObject_Update:107,CustomObject_Delete:108,CustomObject_Get:109,CustomObject_Focus:110,CustomObject_Show:111,CustomObject_Hide:112,CustomObject_SetTintColor:326,HeatMap_Clear:113,CustomTag_Clear:39,
CustomTag_Delete:37,CustomTag_Focus:40,CustomTag_FocusAll:57,CustomTag_Show:58,CustomTag_Hide:59,CustomTag_ShowAll:60,CustomTag_HideAll:61,CustomTag_Add:114,CustomTag_Update:115,CustomTag_Get:116,Polyline_Add:117,Polyline_Update:118,Polyline_Delete:119,Polyline_Clear:120,Polyline_Focus:121,Polyline_Get:122,Polyline_Show:123,Polyline_Hide:124,Polyline_ShowAll:125,Polyline_HideAll:126,VideoProjection_Add:127,VideoProjection_Update:128,VideoProjection_Delete:129,VideoProjection_Show:130,VideoProjection_Hide:131,
...
InfoTree_DeleteByGroupId:156,EditHelper_Start:157,EditHelper_Quit:158,EditHelper_Finish:159,EditHelper_SetParam:160,Settings_SetFovX:161,TileLayer_Actor_ShowAll:162,TileLayer_Actor_HideAll:163,CameraTour_Add:164,CameraTour_Update:165,CameraTour_Play:166,CameraTour_Stop:167,CameraTour_Delete:168,Tag_PopupWindow_Show:169,Tag_PopupWindow_Hide:170,Tag_PopupWindow_ShowAll:171,Tag_PopupWindow_HideAll:172,Settings_SetOceanColor:173,Misc_ShowAllFoliages:174,Misc_HideAllFoliages:175,Tools_StartPolygonClip:176,
Tools_StopClip:177,TileLayer_SetAllowClip:178,Panorama_Add:179,Panorama_Update:180,Panorama_Delete:181,Panorama_Clear:182,Panorama_Focus:183,Panorama_Get:184,Decal_Add:185,Decal_Update:186,Decal_Delete:187,Decal_Clear:188,Decal_Focus:189,Decal_FocusAll:190,Decal_Get:191,Misc_PlayMovie:192,Misc_StopMovie:193,Tools_SetMeasurement:194,Tools_StartMeasurement:195,Tools_StopMeasurement:196,Viewshed_Add:197,Viewshed_Update:198,Viewshed_Focus:199,Viewshed_Delete:200,Viewshed_Clear:201,Viewshed_Get:202,TileLayer_SetStyle:203,
Tools_LineIntersect:204,Coord_PCS2GCS:205,Coord_GCS2PCS:206,DynamicWater_Add:207,DynamicWater_Update:208,DynamicWater_Focus:209,DynamicWater_Delete:210,DynamicWater_Clear:211,DynamicWater_Get:212,DynamicWater_Show:213,DynamicWater_Hide:214,Quit:215,TileLayer_Actor_Unhighlight:216,InfoTree_Get:217,Reset:218,SaveProject:225,CustomObject_Clear:219,CustomObject_Highlight:220,CustomObject_Unhighlight:221,CustomObject_StopHighlight:222,CustomObject_CallFunction:223,CustomObject_AddByTileLayer:224,Tools_StartPlaneClip:226,
Tools_StopPlaneClip:228,Tools_StartVolumeClip:229,Tools_UpdateVolumeClip:230,Tools_StopVolumeClip:231,Tools_StartSkylineAnalysis:232,Tools_StopSkylineAnalysis:233,Tools_ExportSkyline:234,Tools_StartViewshedAnalysis:235,Tools_StopViewshedAnalysis:236,Camera_Move:237,TileLayer_SetCollision:238,TileLayer_Modifier_Add:239,TileLayer_Modifier_Update:240,TileLayer_Modifier_Delete:241,TileLayer_Modifier_Clear:242,Misc_StartProcess:243,Settings_SetCampassVisible:244,Tools_StartGeometryEdit:245,Tools_StopGeometryEdit:246,
Settings_SetEnableInteract:247,Camera_PauseAnimation:248,Camera_ResumeAnimation:249,Settings_SetInteractiveMode:250,CameraTour_Pause:251,CameraTour_Resume:252,Settings_SetTerrainAlpha:253,CustomMesh_Add:254,CustomMesh_Delete:255,CustomMesh_Clear:256,CustomMesh_Update:257,CustomMesh_Get:258,CustomMesh_Focus:259,CustomMesh_Show:260,CustomMesh_Hide:261,CustomMesh_ShowAll:262,CustomMesh_HideAll:263,Settings_EnableCameraMovingEvent:264,Marker_Add:265,Marker_Update:266,Marker_Get:267,Marker_Delete:268,
Marker_Clear:269,Marker_Focus:270,Marker_FocusAll:271,Marker_Show:272,Marker_Hide:273,Marker_ShowAll:274,Marker_HideAll:275,Marker_ShowPopupWindow:276,Marker_HidePopupWindow:277,Marker_ShowAllPopupWindow:278,Marker_HideAllPopupWindow:279,TileLayer_SetViewportVisible:280,TileLayer_GetObjectIDs:281,Polygon3D_StopHighlight:282,Tools_StartFloodFill:283,Tools_StopFloodFill:284,FloodFill_Add:285,FloodFill_Delete:286,FloodFill_Clear:287,FloodFill_Update:288,FloodFill_Get:289,FloodFill_Focus:290,FloodFill_Show:291,
FloodFill_Hide:292,FloodFill_ShowAll:293,FloodFill_HideAll:294,Cesium3DTile_Add:295,Cesium3DTile_Delete:296,Cesium3DTile_Clear:297,Cesium3DTile_Update:298,Cesium3DTile_Get:299,Cesium3DTile_Focus:300,Cesium3DTile_Show:301,Cesium3DTile_Hide:302,Cesium3DTile_ShowAll:303,Cesium3DTile_HideAll:304,TileLayer_GetActorInfoFromDB:305,ShapeFileLayer_Add:306,ShapeFileLayer_Delete:307,ShapeFileLayer_Clear:308,ShapeFileLayer_Update:309,ShapeFileLayer_Get:310,ShapeFileLayer_Focus:311,ShapeFileLayer_Show:312,ShapeFileLayer_Hide:313,
ShapeFileLayer_ShowAll:314,ShapeFileLayer_HideAll:315,ShapeFileLayer_OpenShapeFileLayer:316,Weather_SimulateTime:317,TileLayer_Actor_GetInfo:318,Camera_GetAnimationList:319,TileLayer_CutPolygon_Add:321,TileLayer_CutPolygon_Update:322,TileLayer_CutPolygon_Delete:323,TileLayer_CutPolygon_Clear:324,Marker3D_Add:327,Marker3D_Delete:328,Marker3D_Clear:329,Marker3D_Update:330,Marker3D_Get:331,Marker3D_Focus:332,Marker3D_Show:333,Marker3D_Hide:334,Marker3D_ShowAll:335,Marker3D_HideAll:336,Camera_GetAnimationImage:337,
Tools_ReplaceTexture:338,Tools_RestoreTexture:339,Light_Add:340,Light_Delete:341,Light_Update:343,Light_Get:344,Light_Clear:342,Light_Focus:345,Light_Show:346,Light_Hide:347,Light_ShowAll:348,Light_HideAll:349,WaterMesh_Add:354,WaterMesh_Update:355,WaterMesh_Delete:356,WaterMesh_Clear:357,WaterMesh_Get:358,WaterMesh_Focus:359,WaterMesh_Show:360,WaterMesh_Hide:361,WaterMesh_ShowAll:362,WaterMesh_HideAll:363,CustomObject_StartMove:364,CustomObject_StopMove:365,CustomObject_OverrideMaterial:366,CustomObject_RestoreMaterial:367,
...
Coord_Transform:468,RegisterJsCommunication:469,UnRegisterJsCommunication:470,Vehicle_CallBatchFunction:471,Camera_FlyAround:472,Marker3D_ShowByGroupId:473,Marker3D_HideByGroupId:474,Marker3D_DeleteByGroupId:475,Camera_EnterWorldAnimation:476,Camera_ExitWorldAnimation:477,TileLayer_SetDecalAttach:478,Settings_SetGameBoardVisible:479,Antenna_Add:480,Antenna_Update:481,Antenna_Get:482,Antenna_Focus:483,Antenna_Delete:484,Antenna_Clear:485,Antenna_Show:486,Antenna_Hide:487,TileLayer_Clear:499,Settings_GetWKT:508,
ImageryLayer_AddCustom:510,GeoJSONLayer_Focus:511,ImageryLayer_Focus:512,Marker_SetViewPort:513,GeoJSONLayer_HighlightFeature:514,GeoJSONLayer_UnHighlightFeature:515,GeoJSONLayer_UnHighlightFeaturesById:516,GeoJSONLayer_FocusFeature:517,MarkerLayer_Add:519,MarkerLayer_Update:520,MarkerLayer_Delete:521,MarkerLayer_Clear:522,MarkerLayer_Focus:523,MarkerLayer_Show:524,MarkerLayer_ShowAll:525,MarkerLayer_Hide:526,MarkerLayer_HideAll:527,MarkerLayer_Get:528,MarkerLayer_FocusMarker:529,ImageryLayer_UpdateHeight:530,
Command_End:1E4},za=!1;(()=>{if(!za){za=!0;for(let a in p)p[p[a]]=a}})();class Ma{constructor(a,b){this.id=a;this.visible=b}}class Na{constructor(a,b,c,e){this.id=a.toString();this.coordinate=b;this.radius=c;this.heatValue=e}}class Oa{constructor(a,b,c,e,d,g,h,q,k,f,l,t,x,r){this.id=a.toString();this.coordinate=b;this.imagePath=c;this.imageSize=e;this.url=d;this.text=g;this.range=h||[1,1E5];this.showLine=!!q;this.textColor=k||[0,0,0,1];this.textBackgroundColor=f||[1,1,1,.85];this.textBorderColor=
l||[0,0,0,0];this.textRange=t||1E5;this.hoverImagePath=x;this.autoHidePopupWindow=r||!0}}class Pa{constructor(a,b,c){this.url=a;this.width=b;this.height=c}}class Qa{constructor(a,b,c,e,d,g,h,q){this.id=a.toString();this.coordinate=b;this.contentURL=c.url;this.contentSize=[c.width,c.height];this.popupURL=e.url;this.popupSize=[e.width,e.height];this.pivot=d;this.range=g;this.autoHidePopupWindow=h||!0;this.popupPos=q}}class Ra{constructor(a,b,c,e,d,g){this.id=a.toString();this.coordinates=K(b);this.color=
C(c);this.heightRange=e;this.intensity=d;this.depthTest=g||!0}}class Sa{constructor(a,b,c,e,d,g,h,q){this.id=a.toString();this.x=b;this.y=c;this.width=e;this.height=d;this.normalImage=g;this.hoverImage=h;this.tooltip=q}}class Ta{constructor(a,b,c,e,d,g,h,q,k){this.id=a.toString();this.x=b;this.y=c;this.width=e;this.height=d;this.imageSequecePath=g;this.imageSequeceLength=h;this.loop=!!q;this.interactable=!!k}}class Ua{constructor(a,b,c,e,d,g,h){this.id=a.toString();this.duration=b;this.thickness=
c;this.interval=e;this.velocity=d;this.color=C(g);this.coordinates=h}}class Va{constructor(a,b,c,e,d,g){this.id=a.toString();this.coordinate=b;this.radius=c;this.rippleNumber=e;this.color=C(d);this.brightness=g}}class Wa{constructor(a,b,c,e,d,g,h,q){this.id=a.toString();this.style=b;this.coordinates=K(c);this.color=C(e);this.height=d;this.intensity=g;this.tillingX=h;this.tillingY=q}}class Xa{constructor(a,b,c,e,d,g,h,q,k,f){this.id=a.toString();this.color=C(b);this.coordinates=c;this.style=void 0==
e?0:e;if(0>this.style||5<this.style)this.style=0;this.thickness=void 0==d?20:d;this.brightness=void 0==g?.5:g;this.flowRate=void 0==h?.5:h;this.tiling=q||0;this.depthTest=k||!0;this.shape=void 0==f?0:f}}class Ya{constructor(a,b,c,e,d,g,h,q,k,f,l,t,x,r,y,u,A){this.id=a.toString();this.color=C(b);this.coordinates=c;this.flowRate=void 0==e?.5:e;this.brightness=void 0==d?.5:d;this.bendDegree=void 0==g?.5:g;this.tiling=h||0;this.lineThickness=void 0==q?20:q;this.flowPointSizeScale=void 0==k?20:k;this.labelSizeScale=
void 0==f?100:f;this.lineShape=void 0==l?1:l;this.lineStyle=t||0;this.flowShape=x||0;this.startPointShape=r||0;this.endPointShape=y||0;this.startLabelShape=u||0;this.endLabelShape=A||0;this.endLabelStyle=this.startLabelStyle=this.endPointStyle=this.startPointStyle=this.flowStyle=0}}class Za{constructor(a,b,c,e,d,g,h,q){this.id=a.toString();this.color=C(b);this.coordinates=K(c);this.framecolor=C(e);this.framethickness=d;this.depthTest=g||!0;this.brightness=h;this.style=q;if(0>this.style||10<this.style)this.style=
0}}class $a{constructor(a,b,c,e,d,g){this.id=a.toString();this.imagePath=b;this.coordinate=c;this.yaw=e;this.groupId=d||"";this.userData=g||""}}class ab{constructor(a,b,c,e,d,g,h,q){this.id=a.toString();this.order=b;this.texturePath=c;this.location=e;this.rotation=d;this.scale=g;this.groupId=h;this.userData=q}}class bb{constructor(a,b,c,e,d){this.id=a.toString();this.fileName=b;this.location=c;this.rotation=e;this.scale=d}}class cb{constructor(a,b,c,e,d,g,h){this.id=a;this.pakFilePath=b;this.assetPath=
c;this.location=e;this.rotation=d;this.scale=g;this.smoothMotion=h}}class db{constructor(a,b,c,e,d,g,h){this.id=a;this.tileLayerId=b;this.objectId=c;this.location=e;this.rotation=d;this.scale=g;this.smoothMotion=h}}class eb{constructor(a,b,c,e,d,g,h){this.id=a;this.videoURL=b;this.location=c;this.rotation=e;this.fov=d;this.aspectRatio=g;this.distance=h}}class fb{constructor(a,b,c,e,d){this.id=a;this.coordinates=K(b);this.style=c;this.groupId=e;this.userData=d}}class gb{constructor(a,b,c,e,d){this.actorTag=
a;this.objectName=b;this.functionName=c;this.paramType=e;this.paramValue=d}}class fa{constructor(a,b){this.tileLayerId=a;this.tileLayerActorNames=I(b)}}class hb{constructor(a,b,c,e){this.index=a;this.time=b;this.location=c;this.rotation=e}}class ib{constructor(a,b,c){this.id=a.toString();this.name=b.toString();this.keyFrames=c}}class jb{constructor(){this.queue=[];this.dataMap=new Map}enqueue(a){if(null==a||void 0==a||!a.callbackIndex)return!1;this.queue.push(a.callbackIndex);this.dataMap.set(a.callbackIndex,
a);return!0}dequeue(){if(0!=this.queue.length){const a=this.queue.shift();return this.dataMap.get(a)}}removeData(a){this.dataMap.has(a)&&this.dataMap.delete(a)}dataSize(){return this.dataMap.size}queueSize(){return this.queue.length}}class kb extends jb{constructor(a){super();this.onSendAPI=a;this.timer=null;this.isMainThreadBusy=!1}onMainThreadBusy(a){this.isMainThreadBusy=a.busy}push(a){if(a.__noResponse)this.onSendAPI(a);else 0==this.dataSize()?(this.enqueue(a),this.callNext()):1E4<this.dataSize()?
...
c){return super._updateOneProp(a,"interval",b,c)}setVelocity(a,b,c){return super._updateOneProp(a,"velocity",b,c)}setColor(a,b,c){return super._updateOneProp(a,"color",C(b),c)}setCoordinates(a,b,c){return super._updateOneProp(a,"coordinates",b,c)}}class mb extends P{constructor(a){super(a,"CameraTour")}add(a,b){return super._add(a,b)}update(a,b){return super._update(a,b)}delete(a,b){return super._delete(a,b)}play(a,b){return this.int.call({command:p.CameraTour_Play,ids:I(a)},b)}pause(a){return this.int.call0(p.CameraTour_Pause,
a)}resume(a){return this.int.call0(p.CameraTour_Resume,a)}stop(a){return this.int.call({command:p.CameraTour_Stop},a)}setUserData(a,b,c){return super._updateOneProp(a,"userData",b,c)}setDuration(a,b,c){return super._updateOneProp(a,"duration",b,c)}setKeyFrames(a,b,c){return super._updateOneProp(a,"keyFrames",b,c)}setName(a,b,c){return super._updateOneProp(a,"name",b,c)}}class nb extends P{constructor(a){super(a,"Cesium3DTile")}add(a,b){return super._add(a,b)}update(a,b){return super._update(a,b)}delete(a,
b){return super._delete(a,b)}clear(a){return super._clear(a)}focus(a,b,c,e,d){return super._focus(a,b,c,e,d)}show(a,b){return super._show(a,b)}showAll(a){return super._showAll(a)}hide(a,b){return super._hide(a,b)}hideAll(a){return super._hideAll(a)}get(a,b){return super._get(a,b)}setTileURL(a,b,c){return super._updateOneProp(a,"tileURL",b,c)}}class ob extends P{constructor(a){super(a,"CustomMesh","color")}add(a,b){return super._add(a,b)}update(a,b){return super._update(a,b)}delete(a,b){return super._delete(a,
b)}clear(a){return super._clear(a)}focus(a,b,c,e,d){return super._focus(a,b,c,e,d)}show(a,b){return super._show(a,b)}hide(a,b){return super._hide(a,b)}get(a,b){return super._get(a,b)}setCoordinates(a,b,c){return super._updateOneProp(a,"coordinates",b,c)}setIndices(a,b,c){return super._updateOneProp(a,"indices",b,c)}setColor(a,b,c){return super._updateOneProp(a,"color",b,c)}}const ra={MouseClick:1,MouseMove:2,MouseHover:4},ba={V1:1,V2:2,V3:4,V4:8,All:255},Aa={ClearObjects:1,ResetSettings:2,ResetCamera:4};
class pb extends P{constructor(a){super(a,"CustomObject")}add(a,b){return super._add(a,b)}update(a,b){return super._update(a,b)}delete(a,b){return super._delete(a,b)}clear(a){return super._clear(a)}focus(a,b,c,e,d,g){"function"==typeof c&&(g=c,c=void 0);"function"==typeof e&&(g=e,e=null);"function"==typeof d&&(g=d,d=0);1<d&&(e=2==d?[-45,0,0]:3==d?[0,0,0]:4==d?[-90,0,0]:5==d?[90,0,0]:6==d?[0,90,0]:7==d?[0,270,0]:[0,0,0]);!S(a)&&-1==b&&S(c)&&S(e)&&S(d)&&(d=1,b=0);return this.int.call({command:p.CustomObject_Focus,
ids:I(a),distance:b||0,flyTime:c,rotation:e||null,follow:d||0},g)}show(a,b){return super._show(a,b)}hide(a,b){return super._hide(a,b)}get(a,b){return super._get(a,b)}addByTileLayer(a,b){if(a instanceof Array)for(let c of a)this._fixTileLayerProperty(c);else this._fixTileLayerProperty(a);return this.int.call({command:p.CustomObject_AddByTileLayer,data:F(a)},b)}_fixTileLayerProperty(a){a.tileLayerId instanceof Array||(a.tileLayerId=F(a.tileLayerId));a.objectId instanceof Array||(a.objectId=F(a.objectId))}highlight(a,
b){return this.int.call({command:p.CustomObject_Highlight,ids:I(a)},b)}unhighlight(a,b){return"undefined"==typeof a||"function"==typeof a?("function"==typeof a&&(b=a),this.int.call({command:p.CustomObject_StopHighlight},b)):this.int.call({command:p.CustomObject_Unhighlight,ids:I(a)},b)}glow(a,b){if(a instanceof Array)for(let c of a){let e;e=C(c.color);c.colors=[{color:[e[0]/2,e[1]/2,e[2]/2],value:0},{color:c.color,value:1}]}else o.colors=[{color:o.color,value:0},{color:o.color,value:1}];return this.int.call({command:p.CustomObject_StartGlow,
data:F(a)},b)}stopGlow(a,b){return this.int.call({command:p.CustomObject_StopGlow,ids:I(a)},b)}getBPFunction(a,b){return this.int.call({command:p.Misc_QueryActorOrMaterial,idOrPaths:F(a)},b)}callBPFunction(a,b,c,e,d,g){this.callFunction(a,b,c,e,d,g)}callFunction(a,b,c,e,d,g){return this.int.call({command:p.CustomObject_CallFunction,data:F({id:a.toString(),functionName:b,paramType:c,paramValue:e,parameters:d})},g)}callBatchBPFunction(a,b){this.callFunction4CustomObjectArr(a,b)}callBatchFunction(a,
...
data:F(a)},b)}setRotation(a,b,c){return super._updateOneProp(a,"rotation",b,c)}setLocalRotation(a,b,c){return super._updateOneProp(a,"localRotation",b,c)}setScale(a,b,c){return super._updateOneProp(a,"scale",b,c)}setSmoothMotion(a,b,c){return super._updateOneProp(a,"smoothMotion",b,c)}setTintColor(a,b,c){a={ids:F(a),color:C(b)};return this.int.call({command:p.CustomObject_SetTintColor,data:F(a)},c)}overrideMaterial(a,b){return this.int.call({command:p.CustomObject_OverrideMaterial,data:F(a)},b)}restoreMaterial(a,
...
data:F(c)},e)}stopMove(a,b){return this.int.call({command:p.CustomObject_StopMove,id:a},b)}}class qb extends P{constructor(a){super(a,"CustomTag")}add(a,b){return super._add(a,b)}update(a,b){return super._update(a,b)}delete(a,b){return super._delete(a,b)}clear(a){return super._clear(a)}focus(a,b,c,e,d){return super._focus(a,b,c,e,d)}focusAll(a,b,c,e){return super._focusAll(a,b,c,e)}show(a,b){return super._show(a,b)}showAll(a){return super._showAll(a)}hide(a,b){return super._hide(a,b)}hideAll(a){return super._hideAll(a)}get(a,
b){return super._get(a,b)}setAutoHidePopupWindow(a,b,c){return super._updateOneProp(a,"autoHidePopupWindow",b,c)}}class rb extends P{constructor(a){super(a,"Decal")}add(a,b){return super._add(a,b)}update(a,b){return super._update(a,b)}delete(a,b){return super._delete(a,b)}clear(a){return super._clear(a)}focus(a,b,c,e,d){return super._focus(a,b,c,e,d)}focusAll(a,b,c,e){return super._focusAll(a,b,c,e)}get(a,b){return super._get(a,b)}}class sb extends P{constructor(a){super(a,"DynamicWater")}add(a,b){return super._add(a,
b)}update(a,b){return super._update(a,b)}delete(a,b){return super._delete(a,b)}clear(a){return super._clear(a)}focus(a,b,c,e,d){return super._focus(a,b,c,e,d)}focusAll(a,b,c,e){return super._focusAll(a,b,c,e)}get(a,b){return super._get(a,b)}setCoordinates(a,b,c){return super._updateOneProp(a,"coordinates",K(b),c)}setMaterialPath(a,b,c){return super._updateOneProp(a,"materialPath",b,c)}setStyle(a,b,c){return super._updateOneProp(a,"style",b,c)}}class tb extends P{constructor(a){super(a,"FloodFill",
...
console.error("\u6570\u7ec4\u53c2\u6570\u683c\u5f0f\u4e0d\u6b63\u786e.")}setMin(a,b,c){return super._updateOneProp(a,"min",b,c)}setMax(a,b,c){return super._updateOneProp(a,"max",b,c)}setSeed(a,b,c){return super._updateOneProp(a,"seed",b,c)}setElevation(a,b,c){return super._updateOneProp(a,"elevation",b,c)}setColor(a,b,c){return super._updateOneProp(a,"color",C(b),c)}setPrecision(a,b,c){return super._updateOneProp(a,"precision",b,c)}}class ub extends P{constructor(a){super(a,"GeoJSONLayer")}add(a,
b){this.load(a,b)}load(a,b){a.sourceJson&&(a.url=a.sourceJson);"object"==typeof a.url&&(a.url=JSON.stringify(a.url));return super._add(a,b)}show(a,b){return super._show(a,b)}hide(a,b){return super._hide(a,b)}delete(a,b){return super._delete(a,b)}focus(a,b,c,e,d){return super._focus(a,b,c,e,d)}highlightFeature(a,b,c){return this.int.call({command:p.GeoJSONLayer_HighlightFeature,data:F({id:a,featureIds:[b]})},c)}stopHighlightFeature(a,b,c){return this.int.call({command:p.GeoJSONLayer_UnHighlightFeature,
data:F({id:a,featureIds:[b]})},c)}highlightFeatures(a,b){return this.int.call({command:p.GeoJSONLayer_HighlightFeature,data:F(a)},b)}stopHighlightFeatures(a,b){return this.int.call({command:p.GeoJSONLayer_UnHighlightFeature,data:F(a)},b)}stopAllHighlightFeaturesById(a,b){return this.int.call({command:p.GeoJSONLayer_UnHighlightFeaturesById,ids:F(a)},b)}focusFeature(a,b,c,e,d,g){return this.int.call({command:p.GeoJSONLayer_FocusFeature,data:F({id:a,featureIds:[b]}),distance:c,flyTime:e,rotation:d},
g)}}class vb extends P{constructor(a){super(a,"HeatMap")}_checkBBox(a){if(a instanceof Array){if(6!=a.length||a[0]>a[3]||a[1]>a[4]||a[2]>a[5])return!1}else return!1;return!0}add(a,b,c,e,d,g,h,q,k,f,l){return this._checkBBox(b)?"undefined"==typeof d||"function"==typeof d?this.int.call({command:p.HeatMap_Add,id:a.toString(),bbox:b,range:c,data:F(e),style:-1},l):0==d||1==d?this.int.call({command:p.HeatMap_Add,id:a.toString(),bbox:b,range:c,data:F(e),style:d,textureSize:g,opacityMode:h,opacityRange:q,
...
!1)}}class wb extends P{constructor(a){super(a,"HeatMap3D")}_checkBBox(a){if(a instanceof Array){if(6!=a.length||a[0]>a[3]||a[1]>a[4]||a[2]>a[5])return!1}else return!1;return!0}add(a,b){return super._add(a,b)}addVoxels(a,b){return this.int.call({command:p.HeatMap_AddVoxels,data:F(a)},b)}update(a,b){return super._update(a,b)}delete(a,b){return super._delete(a,b)}clear(a){return super._clear(a)}focus(a,b,c,e,d){return super._focus(a,b,c,e,d)}show(a,b){return super._show(a,b)}hide(a,b){return super._hide(a,
b)}get(a,b){return super._get(a,b)}setDisplayMode(a,b,c){return this.int.call({command:p.HeatMap3D_Update,id:a,displayMode:b},c)}}class xb extends P{constructor(a){super(a,"HighlightArea","color")}add(a,b){return super._add(a,b)}update(a,b){return super._update(a,b)}delete(a,b){return super._delete(a,b)}clear(a){return super._clear(a)}focus(a,b,c,e,d){return super._focus(a,b,c,e,d)}show(a,b){return super._show(a,b)}hide(a,b){return super._hide(a,b)}get(a,b){return super._get(a,b)}setColor(a,b,c){return super._updateOneProp(a,
"color",C(b),c)}setCoordinates(a,b,c){return super._updateOneProp(a,"coordinates",b,c)}setHeightRange(a,b,c){return super._updateOneProp(a,"heightRange",b,c)}setIntensity(a,b,c){return super._updateOneProp(a,"intensity",b,c)}setDepthTest(a,b,c){return super._updateOneProp(a,"depthTest",b,c)}}class yb extends P{constructor(a){super(a,"ImageryLayer")}init(a,b){return this.int.call({command:p.ImageryLayer_Init,xmlPath:a.xmlUrl,layerName:a.layerName,tileMatrixName:a.tileMatrixName,ogcEPSG:a.ogcEPSG,cachePath:a.cachePath,
mapMode:a.mapMode,renderMode:a.renderMode},b)}add(a,b){const c=this;return $jscomp.asyncExecutePromiseGeneratorFunction(function*(){return a instanceof Array?new Promise(e=>$jscomp.asyncExecutePromiseGeneratorFunction(function*(){let d;for(let g of a)if(d=yield c.addOne(g,b),0!=d.result){e(d);break}e(d)})):c.addOne(a,b)})}addOne(a,b){return this.int.call({command:p.ImageryLayer_Add,id:a.id,url:a.url,xmlPath:a.xmlPath,layerName:a.layerName,tileMatrixName:a.tileMatrixName,ogcEPSG:a.ogcEPSG},b)}setGlobalHeight(a,
b){return this.int.call({command:p.ImageryLayer_UpdateHeight,height:a},b)}show(a,b){return super._show(a,b)}hide(a,b){return super._hide(a,b)}delete(a,b){return super._delete(a,b)}focus(a,b,c,e,d){return super._focus(a,b,c,e,d)}}class zb extends P{constructor(a){super(a,"Light","color")}add(a,b){return super._add(a,b)}update(a,b){return super._update(a,b)}delete(a,b){return super._delete(a,b)}clear(a){return super._clear(a)}focus(a,b,c,e,d){return super._focus(a,b,c,e,d)}show(a,b){return super._show(a,
b)}showAll(a){return super._showAll(a)}hide(a,b){return super._hide(a,b)}hideAll(a){return super._hideAll(a)}get(a,b){return super._get(a,b)}}class Ab extends P{constructor(a){super(a,"Marker","fontColor|fontOutlineColor|textBackgroundColor|lineColor")}add(a,b){this._fixMarkerData(a,"add");return super._add(a,b)}_fixMarkerProperty(a,b){a.textColor&&(a.fontColor=a.textColor);a.url&&(a.popupURL=a.url);a.dispalyMode&&(a.displayMode=a.dispalyMode);S(a.displayMode)&&"add"==b&&(a.displayMode=4);a.popupURL&&
!a.popupSize&&"add"==b&&(a.popupSize=[600,400]);0==a.showLine&&(a.lineSize=[0,0]);1!=a.showLine||null!=a.lineSize&&void 0!=a.lineSize||(a.lineSize=[2,100]);4==a.displayMode&&0<a.autoDisplayModeSwitchFirstRatio&&0<a.autoDisplayModeSwitchSecondRatio&&(a.autoDisplayModeSwitchRatio=[a.autoDisplayModeSwitchFirstRatio,a.autoDisplayModeSwitchSecondRatio])}_fixMarkerData(a,b){if(a instanceof Array)for(let c of a)this._fixMarkerProperty(c,b);else this._fixMarkerProperty(a,b)}update(a,b){this._fixMarkerData(a,
"update");return super._update(a,b)}delete(a,b){return super._delete(a,b)}clear(a){return super._clear(a)}focus(a,b,c,e,d){return super._focus(a,b,c,e,d)}focusAll(a,b,c,e){return super._focusAll(a,b,c,e)}show(a,b){return super._show(a,b)}showAll(a){return super._showAll(a)}hide(a,b){return super._hide(a,b)}hideAll(a){return super._hideAll(a)}showPopupWindow(a,b){return this.int.call({command:p.Marker_ShowPopupWindow,ids:I(a)},b)}hidePopupWindow(a,b){return this.int.call({command:p.Marker_HidePopupWindow,
ids:I(a)},b)}showAllPopupWindow(a){return this.int.call0(p.Marker_ShowAllPopupWindow,a)}hideAllPopupWindow(a){return this.int.call0(p.Marker_HideAllPopupWindow,a)}get(a,b){return super._get(a,b)}setGroupId(a,b,c){return super._updateOneProp(a,"groupId",b,c)}setUserData(a,b,c){return super._updateOneProp(a,"userData",b,c)}setAnchors(a,b,c){return this.setScreenOffset(a,b,c)}setScreenOffset(a,b,c){return super._updateOneProp(a,"anchors",b,c)}setCoordinate(a,b,c){return super._updateOneProp(a,"coordinate",
...
b){return this.int.call({command:p.Marker_SetupPOIAttachment,data:F(a)},b)}setViewportVisible(a,b,c){let e=[];e.push({viewportIndex:1,viewportVisible:!!(b&Viewport.V1)});e.push({viewportIndex:2,viewportVisible:!!(b&Viewport.V2)});e.push({viewportIndex:3,viewportVisible:!!(b&Viewport.V3)});e.push({viewportIndex:4,viewportVisible:!!(b&Viewport.V4)});return this.int.call({command:p.Marker_SetViewPort,id:a,data:e},c)}showByGroupId(a,b){return this.int.call({command:p.Marker_ShowByGroupId,ids:F(a)},b)}hideByGroupId(a,
b){return this.int.call({command:p.Marker_HideByGroupId,ids:F(a)},b)}deleteByGroupId(a,b){return this.int.call({command:p.Marker_DeleteByGroupId,ids:F(a)},b)}}class Bb extends P{constructor(a){super(a,"Marker3D","textColor|textOutlineColor")}add(a,b){return super._add(a,b)}update(a,b){return super._update(a,b)}delete(a,b){return super._delete(a,b)}clear(a){return super._clear(a)}focus(a,b,c,e,d){return super._focus(a,b,c,e,d)}show(a,b){return super._show(a,b)}showAll(a){return super._showAll(a)}hide(a,
b){return super._hide(a,b)}hideAll(a){return super._hideAll(a)}get(a,b){return super._get(a,b)}showByGroupId(a,b){return this.int.call({command:p.Marker3D_ShowByGroupId,groupIds:I(a)},b)}hideByGroupId(a,b){return this.int.call({command:p.Marker3D_HideByGroupId,groupIds:I(a)},b)}deleteByGroupId(a,b){return this.int.call({command:p.Marker3D_DeleteByGroupId,groupIds:I(a)},b)}}class Cb extends P{constructor(a){super(a,"ODLine","color")}add(a,b){this._fixODlineData(a);return super._add(a,b)}_fixODlineProperty(a){a.intensity&&
...
"startLabelShape",b,c)}setEndLabelShape(a,b,c){return super._updateOneProp(a,"endLabelShape",b,c)}}class Db extends P{constructor(a){super(a,"Panorama")}add(a,b){return super._add(a,b)}update(a,b){return super._update(a,b)}delete(a,b){return super._delete(a,b)}clear(a){return super._clear(a)}focus(a,b,c,e,d){return super._focus(a,b,c,e,d)}get(a,b){return super._get(a,b)}enter(a,b){return this.int.call({command:p.Panorama_Enter,ids:I(a)},b)}exit(a){return this.int.call({command:p.Panorama_Exit},a)}switchMode(a){return this.int.call({command:p.Panorama_Switch},
a)}}class Eb extends P{constructor(a){super(a,"Polygon","color|frameColor")}add(a,b){this._fixPolygonData(a);return super._add(a,b)}_fixPolygonProperty(a){a.brightness=0==a.intensity||1==a.intensity?a.intensity:1;11==a.style&&(a.style=0,a.brightness=1,a.intensity=1)}_fixPolygonData(a){if(a instanceof Array)for(let b of a)this._fixPolygonProperty(b);else this._fixPolygonProperty(a)}update(a,b){this._fixPolygonData(a);return super._update(a,b)}delete(a,b){return super._delete(a,b)}clear(a){return super._clear(a)}focus(a,
b,c,e,d){return super._focus(a,b,c,e,d)}show(a,b){return super._show(a,b)}hide(a,b){return super._hide(a,b)}get(a,b){return super._get(a,b)}glow(a,b,c){return this.int.call({command:p.Polygon_Glow,ids:I(a),duration:b},c)}highlight(a,b){return this.int.call({command:p.Polygon_Highlight,ids:I(a)},b)}stopHighlight(a,b){return this.int.call({command:p.Polygon_StopHighlight,ids:I(a)},b)}setCoordinates(a,b,c){return super._updateOneProp(a,"coordinates",K(b),c)}setColor(a,b,c){return super._updateOneProp(a,
"color",C(b),c)}setDepthTest(a,b,c){return super._updateOneProp(a,"depthTest",b,c)}}class Fb extends P{constructor(a){super(a,"Polygon3D","color")}add(a,b){this._fixPolygonData(a);return super._add(a,b)}_fixPolygonProperty(a){11==a.style&&(a.style=9,a.intensity=1)}_fixPolygonData(a){if(a instanceof Array)for(let b of a)this._fixPolygonProperty(b);else this._fixPolygonProperty(a)}update(a,b){return super._update(a,b)}delete(a,b){return super._delete(a,b)}clear(a){return super._clear(a)}focus(a,b,c,
e,d){return super._focus(a,b,c,e,d)}show(a,b){return super._show(a,b)}hide(a,b){return super._hide(a,b)}get(a,b){return super._get(a,b)}showAll(a){return super._showAll(a)}hideAll(a){return super._hideAll(a)}highlight(a,b){return this.int.call({command:p.Polygon3D_Highlight,ids:I(a)},b)}stopHighlight(a,b){return this.int.call({command:p.Polygon3D_StopHighlight,ids:I(a)},b)}glow(a,b){if(a instanceof Array)for(let c of a){let e;e=C(c.color);c.colors=[{color:[e[0]/2,e[1]/2,e[2]/2],value:0},{color:c.color,
value:1}]}else o.colors=[{color:o.color,value:0},{color:o.color,value:1}];return this.int.call({command:p.Polygon3D_Glow,data:F(a)},b)}stopGlow(a,b){return this.int.call({command:p.Polygon3D_StopGlow,ids:I(a)},b)}setStyle(a,b,c){return super._updateOneProp(a,"style",b,c)}setCoordinates(a,b,c){return super._updateOneProp(a,"coordinates",b,c)}setColor(a,b,c){return super._updateOneProp(a,"color",C(b),c)}setHeight(a,b,c){return super._updateOneProp(a,"height",b,c)}setIntensity(a,b,c){return super._updateOneProp(a,
"intensity",b,c)}setTillingX(a,b,c){return super._updateOneProp(a,"tillingX",b,c)}setTillingY(a,b,c){return super._updateOneProp(a,"tillingY",b,c)}}class Gb extends P{constructor(a){super(a,"Polyline","color")}add(a,b){this._fixPolylineData(a);return super._add(a,b)}_fixPolylineProperty(a){a.intensity&&(a.brightness=a.intensity);8==a.style&&(a.style=4,a.brightness=1,a.intensity=1)}_fixPolylineData(a){if(a instanceof Array)for(let b of a)this._fixPolylineProperty(b);else this._fixPolylineProperty(a)}update(a,
...
"thickness",b,c)}setColor(a,b,c){return super._updateOneProp(a,"color",C(b),c)}setFlowRate(a,b,c){return super._updateOneProp(a,"flowRate",b,c)}setBrightness(a,b,c){return super._updateOneProp(a,"brightness",b,c)}setShape(a,b,c){return super._updateOneProp(a,"shape",b,c)}setDepth(a,b,c){return super._updateOneProp(a,"depthTest",b,c)}}class Hb extends P{constructor(a){super(a,"RadiationPoint","color")}add(a,b){this._fixRadiationPointData(a);return super._add(a,b)}_fixRadiationPointProperty(a){a.intensity&&
...
b){return super._get(a,b)}setCoordinate(a,b,c){return super._updateOneProp(a,"coordinate",b,c)}setRadius(a,b,c){return super._updateOneProp(a,"radius",b,c)}setRippleNumber(a,b,c){return super._updateOneProp(a,"rippleNumber",b,c)}setColor(a,b,c){return super._updateOneProp(a,"color",C(b),c)}setBrightness(a,b,c){return super._updateOneProp(a,"brightness",b,c)}setAutoHeight(a,b,c){return super._updateOneProp(a,"autoHeight",b,c)}}class Ib extends P{constructor(a){super(a,"ShapeFileLayer","color")}add(a,
...
data:F(a)},b)}focusFeature(a,b,c,e,d,g){return this.int.call({command:p.ShapeFileLayer_FocusFeature,data:F({shpId:a,featureIds:[b]}),distance:c,flyTime:e,rotation:d},g)}getFeature(a,b){return this.int.call({command:p.ShapeFileLayer_GetFeatureInfo,data:F(a)},b)}}class Jb extends P{constructor(a){super(a,"Tag","textColor|textBackgroundColor|textBorderColor")}add(a,b){return super._add(a,b)}update(a,b){return super._update(a,b)}delete(a,b){return super._delete(a,b)}clear(a){return super._clear(a)}focus(a,
...
b,c)}showPopupWindow(a,b){return this.int.call({command:p.Tag_PopupWindow_Show,ids:I(a)},b)}hidePopupWindow(a,b){return this.int.call({command:p.Tag_PopupWindow_Hide,ids:I(a)},b)}showAllPopupWindow(a){return this.int.call0(p.Tag_PopupWindow_ShowAll,a)}hideAllPopupWindow(a){return this.int.call0(p.Tag_PopupWindow_HideAll,a)}}class Kb extends P{constructor(a){super(a,"TileLayer")}add(a,b){return super._add(a,b)}update(a,b){return super._update(a,b)}delete(a,b){return super._delete(a,b)}focus(a,b,c,
e,d){return super._focus(a,b,c,e,d)}clear(a){return super._clear(a)}show(a,b){return super._show(a,b)}hide(a,b){return super._hide(a,b)}get(a,b){return super._get(a,b)}getAllFlattenInfo(a){return this.int.call({command:p.TileLayer_GetAllFlattenData},a)}getActorInfoFromDB(a,b){return this.int.call({command:p.TileLayer_GetActorInfoFromDB,data:F(a)},b)}enableXRay(a,b,c){return this.int.call({command:p.TileLayer_EnableXRay,ids:I(a),color:C(b)},c)}disableXRay(a,b){return this.int.call({command:p.TileLayer_DisableXRay,
ids:I(a)},b)}enableClip(a,b){let c=[];a=F(a);for(let e of a)c.push({id:e,allowClip:!0});return this.int.call({command:p.TileLayer_SetAllowClip,data:c},b)}disableClip(a,b){let c=[];a=F(a);for(let e of a)c.push({id:e,allowClip:!1});return this.int.call({command:p.TileLayer_SetAllowClip,data:c},b)}setFileName(a,b,c){return super._updateOneProp(a,"fileName",b,c)}setLocation(a,b,c){return super._updateOneProp(a,"location",b,c)}setTranslation(a,b,c){return this.setLocation(a,b,c)}setRotation(a,b,c){return super._updateOneProp(a,
"rotation",b,c)}setScale(a,b,c){return super._updateOneProp(a,"scale",b,c)}showActor(a,b,c){a=new fa(a,b);return this.int.call({command:p.TileLayer_Actor_Show,data:F(a)},c)}showActors(a,b){let c=[];if(a instanceof Array)for(let d=0;d<a.length;d++){var e=a[d];e={tileLayerId:e.id,tileLayerActorNames:I(e.objectIds)};c.push(e)}else a={tileLayerId:a.id,tileLayerActorNames:I(a.objectIds)},c.push(a);return this.int.call({command:p.TileLayer_Actor_Show,data:c},b)}hideActor(a,b,c){a=new fa(a,b);return this.int.call({command:p.TileLayer_Actor_Hide,
data:F(a)},c)}hideActors(a,b){let c=[];if(a instanceof Array)for(let d=0;d<a.length;d++){var e=a[d];e={tileLayerId:e.id,tileLayerActorNames:I(e.objectIds)};c.push(e)}else a={tileLayerId:a.id,tileLayerActorNames:I(a.objectIds)},c.push(a);return this.int.call({command:p.TileLayer_Actor_Hide,data:c},b)}focusActor(a,b,c,e,d,g){a=new fa(a,b);return this.int.call({command:p.TileLayer_Actor_Focus,data:F(a),distance:c,flyTime:e,rotation:d},g)}focusActors(a,b,c,e,d){a=new fa(a.id,a.objectIds);return this.int.call({command:p.TileLayer_Actor_Focus,
...
"aspectRatio",b,c)}setDistance(a,b,c){return super._updateOneProp(a,"distance",b,c)}setDepthCulling(a,b,c){return super._updateOneProp(a,"depthCulling",b,c)}setFrustumColor(a,b,c){return super._updateOneProp(a,"frustumColor",b,c)}}class Nb extends P{constructor(a){super(a,"WaterFlowField")}add(a,b){return super._add(a,b)}update(a,b){return super._update(a,b)}delete(a,b){return super._delete(a,b)}clear(a){return super._clear(a)}focus(a,b,c,e,d){return super._focus(a,b,c,e,d)}show(a,b){return super._show(a,
b)}hide(a,b){return super._hide(a,b)}get(a,b){return super._get(a,b)}}class Ob extends P{constructor(a){super(a,"WaterMesh","waterColor")}add(a,b){return super._add(a,b)}update(a,b){return super._update(a,b)}delete(a,b){return super._delete(a,b)}clear(a){return super._clear(a)}focus(a,b,c,e,d){return super._focus(a,b,c,e,d)}show(a,b){return super._show(a,b)}hide(a,b){return super._hide(a,b)}showAll(a){return super._showAll(a)}hideAll(a){return super._hideAll(a)}get(a,b){return super._get(a,b)}setCoordinates(a,
b,c){return super._updateOneProp(a,"coordinates",b,c)}setIndices(a,b,c){return super._updateOneProp(a,"indices",b,c)}setNormals(a,b,c){return super._updateOneProp(a,"normals",b,c)}setWaterColor(a,b,c){return super._updateOneProp(a,"waterColor",b,c)}setWaterSpeed(a,b,c){return super._updateOneProp(a,"waterSpeed",b,c)}setWaterUVRepeat(a,b,c){return super._updateOneProp(a,"waterUVRepeat",b,c)}setWaterDirection(a,b,c){return super._updateOneProp(a,"waterDirection",b,c)}setWaterWaveScale(a,b,c){return super._updateOneProp(a,
"waveScale",b,c)}}class Pb extends P{constructor(a){super(a,"MarkerLayer","color|fontColor|fontOutlineColor|textBackgroundColor|lineColor")}add(a,b){return super._add(a,b)}update(a,b){return super._update(a,b)}delete(a,b){return super._delete(a,b)}clear(a){return super._clear(a)}focus(a,b,c,e,d){return super._focus(a,b,c,e,d)}focusByMarkerId(a,b,c,e,d,g){return this.int.call({command:p.MarkerLayer_FocusMarker,data:[{id:a,ids:[b]}],distance:c,flyTime:e,rotation:d},g)}show(a,b){return super._show(a,
b)}showAll(a){return super._showAll(a)}hide(a,b){return super._hide(a,b)}hideAll(a){return super._hideAll(a)}}var Ba="en",ua={},Ca={VersionMismatch:["\u8b66\u544a\uff1a\n--------------------------------------------------\n    ac.min.js\u6587\u4ef6\u7248\u672c\uff08{0}\uff09\u548c\u4e91\u6e32\u67d3\u670d\u52a1\u5668\u7248\u672c\uff08{1}\uff09\u4e0d\u4e00\u81f4\uff0c\n    \u53ef\u80fd\u9020\u6210\u63a5\u53e3\u8c03\u7528\u9519\u8bef\u6216\u5d29\u6e83\uff0c\u8bf7\u786e\u8ba4!","Warning:\n--------------------------------------------- -----\n The version of the ac.min.js file ({0}) and the version of the cloud rendering server ({1}) are inconsistent,\n may cause interface call errors or crashes, please confirm!"],
...
b=0;b<arguments.length;b++)a=a.replace(new RegExp("\\{"+b+"\\}","g"),arguments[b]);return a};class H{}H.onLanguageChangedCallbacks=[];H.setLanguage=a=>{Ba="zh"===a?"zh":"en";ua={};a="zh"==Ba;for(let b in Ca){let c=Ca[b];ua[b]=a?c[0]:c[1]}for(let b of H.onLanguageChangedCallbacks)"function"==typeof b&&b()};H.getString=a=>ua[a];class Qb{constructor(a){this.int=a;this._useOldDataFormat=!1}useOldDataFormat(a){this._useOldDataFormat=a||!0}get(a){return this.int.call0(p.Camera_GetCamera,a)}_setByArray(a,
...
(q=h,h=void 0);if(this._useOldDataFormat){let k=d;d=g;g=k}return this.int.call({command:p.Camera_Set,coordinate:[a,b,c],distance:e,pitch:d||0,yaw:g||0,flyTime:h},q)}lookAtBBox(a,b,c,e,d){"function"==typeof e&&(d=e,e=void 0);if(this._useOldDataFormat){let g=b;b=c;c=g}return this.int.call({command:p.Camera_LookAtBBox,bbox:a,pitch:b||0,yaw:c||0,flyTime:e},d)}playAnimation(a,b){return this.int.call({command:p.Camera_PlayAnimation,id:a},b)}stopAnimation(a){return this.int.call0(p.Camera_StopAnimation,
...
a)}stop(a){return this.int.call({command:p.Camera_Move,stop:!0},a)}getEulerAngle(a,b){const c=360/(2*Math.PI);let e=b[0]-a[0],d=b[1]-a[1];return[Math.atan2(b[2]-a[2],Math.sqrt(e*e+d*d))*c,Math.atan2(e,d)*c-90,0]}lockByBBox(a,b){return this.int.call({command:p.Camera_LockBBox,bbox:a},b)}unlock(a){return this.int.call({command:p.Camera_UnLockBBox},a)}flyAround(a,b,c,e,d){return this.int.call({command:p.Camera_FlyAround,coordinate:a,rotation:b||[0,90,0],distance:c||1E3,time:e||10},d)}enterWorld(a){return this.int.call({command:p.Camera_ExitWorldAnimation},
a)}exitWorld(a){return this.int.call({command:p.Camera_EnterWorldAnimation},a)}}class Rb{constructor(a){this.int=a}screen2World(a,b,c){return this.int.call({command:p.Coord_Screen2World,screenPosition:[a,b]},c)}world2Screen(a,b,c,e){return this.int.call({command:p.Coord_World2Screen,worldlocation:[a,b,c]},e)}gcs2pcs(a,b,c){"function"==typeof b&&(c=b);S(b)&&(b=1);if(1==b)return this.int.call({command:p.Coord_GCS2PCS,coordinates:O(a)},c);2==b?this.transform(O(a),2,0,c):3==b?this.transform(O(a),3,0,
c):console.error("\u672a\u77e5\u5750\u6807\u7cfb\u7c7b\u578b")}pcs2gcs(a,b,c){"function"==typeof b&&(c=b);S(b)&&(b=1);if(1==b)return this.int.call({command:p.Coord_PCS2GCS,coordinates:O(a)},c);2==b?this.transform(O(a),0,2,c):3==b?this.transform(O(a),0,3,c):console.error("\u672a\u77e5\u5750\u6807\u7cfb\u7c7b\u578b")}transform(a,b,c,e){return this.int.call({command:p.Coord_Transform,coordinates:O(a),src:b,dest:c},e)}}class Sb{constructor(a){this.int=a}start(a){return this.int.call0(p.EditHelper_Start,
a)}cancel(a){return this.int.call0(p.EditHelper_Quit,a)}finish(a,b){return this.int.call({command:p.EditHelper_Finish,withOffset:a||!0},b)}setParam(a,b,c,e){return this.int.call({command:p.EditHelper_SetParam,lineType:a,buildType:b,color:C(c)},e)}}class Tb{constructor(a){this.int=a}setVisibility(a,b){return this.int.call({command:p.InfoTree_SetVisibility,layers:F(a)},b)}show(a,b){return this.int.call({command:p.InfoTree_Show,ids:I(a)},b)}hide(a,b){return this.int.call({command:p.InfoTree_Hide,ids:I(a)},
b)}enableXRay(a,b,c){return this.int.call({command:p.InfoTree_EnableXRay,ids:F(a),color:C(b)},c)}disableXRay(a,b){return this.int.call({command:p.InfoTree_DisableXRay,ids:F(a)},b)}showByGroupId(a,b){return this.int.call({command:p.InfoTree_ShowByGroupId,ids:I(a)},b)}hideByGroupId(a,b){return this.int.call({command:p.InfoTree_HideByGroupId,ids:I(a)},b)}highlightByGroupId(a,b){return this.int.call({command:p.InfoTree_HighlightByGroupId,ids:I(a)},b)}deleteByGroupId(a,b){return this.int.call({command:p.InfoTree_DeleteByGroupId,
ids:I(a)},b)}get(a){return this.int.call0(p.InfoTree_Get,a)}focus(a,b){return this.int.call({command:p.InfoTree_Focus,ids:I(a)},b)}}class Ub{constructor(a){this.int=a;this.apiVersion="6.0";this.apiVersionServer=""}isApiVersionMatched(){return"1.0.0"==this.apiVersionServer||this.apiVersionServer==this.int.getVersion()}addImageButtons(a,b){return this.int.call({command:p.Misc_AddImageButton,data:F(a)},b)}deleteImageButtons(a,b){return this.int.call({command:p.Misc_DeleteImageButton,ids:I(a)},b)}addAnimatedImageButtons(a,
b){return this.int.call({command:p.Misc_AddAnimatedImageButton,data:F(a)},b)}setApiVersionReceived(a){this.int.onApiVersionReceived=a}playVideo(a,b,c,e,d,g,h){return this.int.call({command:p.Misc_PlayVideo,data:[{id:a.toString(),position:[b,c],size:[e,d],url:g}]},h)}stopPlayVideo(a,b){return this.int.call({command:p.Misc_StopPlayVideo,ids:I(a)},b)}playMovie(a,b,c){"function"==typeof b&&(c=b,b=!1);return this.int.call({command:p.Misc_PlayMovie,loop:b,url:a},c)}stopMovie(a){return this.int.call({command:p.Misc_StopMovie},
...
a)}setWMTSLayerVisible(a,b){this.setwmtsLayerVisible(a,b)}setwmtsLayerVisible(a,b){return this.int.call({command:p.Settings_SetWMTSLayerVisible,data:F(a)},b)}setWMTSLayerOpacity(a,b){return this.int.call({command:p.Settings_SetWMTSLayerOpacity,data:F(a)},b)}setMapURL(a,b){return this.int.call({command:p.Settings_SetMapURL,url:a},b)}highlightColor(a,b){return this.setHighlightColor(a,b)}setHighlightColor(a,b){return this.int.call({command:p.Settings_SetHighlightColor,color:C(a)},b)}setFovX(a,b){return this.int.call({command:p.Settings_SetFovX,
value:a},b)}setOceanColor(a,b){return this.int.call({command:p.Settings_SetOceanColor,color:C(a)},b)}setEnableInteract(a,b){return this.int.call({command:p.Settings_SetEnableInteract,enableInteract:a},b)}setInteractiveMode(a,b){return this.int.call({command:p.Settings_SetInteractiveMode,mode:a},b)}setRoleLocation(a,b,c){return this.int.call({command:p.Settings_SetInteractiveMode,mode:1,location:a,rotation:b},c)}getInteractiveMode(a){return this.int.call({command:p.Settings_GetInteractiveMode},a)}setCampassVisible(a,
b){return this.int.call({command:p.Settings_SetCampassVisible,visible:a},b)}setCampassPosition(a,b,c){return this.int.call({command:p.Settings_SetCampassPosition,position:[a,b]},c)}setMainUIVisibility(a,b){return this.int.call({command:p.Settings_SetMainUIVisibility,visible:a},b)}setMousePickMask(a,b){let c=!1,e=!1,d=!1;a&ra.MouseClick&&(c=!0);a&ra.MouseMove&&(e=!0);a&ra.MouseHover&&(d=!0);return this.int.call({command:p.Settings_SetMousePickMask,mouseClick:c,mouseMove:e,mouseHover:d},b)}setTerrainAlpha(a,
...
coordOrder:b.coordOrder,maxLevel:b.maxLevel},c)}getMapMode(a){return this.int.call0(p.Settings_GetMapMode,a)}}class Xb{constructor(a){this.int=a}startPolygonClip(a,b,c){return this.int.call({command:p.Tools_StartPolygonClip,data:F({id:"0",coordinates:K(a),toggleImageCut:b})},c)}startPlaneClip(a,b,c,e,d){return this.int.call({command:p.Tools_StartPlaneClip,location:a,rotation:b,isShowPlane:c,isEdit:e},d)}startVolumeClip(a,b,c,e,d,g){return this.int.call({command:p.Tools_StartVolumeClip,bbox:a,rotation:d,
...
data:F(a),highPrecision:b,returnDetails:c},e)}startGeometryEdit(a,b,c){return this.int.call({command:p.Tools_StartGeometryEdit,id:a,type:b},c)}stopGeometryEdit(a){return this.int.call0(p.Tools_StopGeometryEdit,a)}startSkylineAnalysis(a,b){a=a||{};a.outlineColor&&(a.outlineColor=C(a.outlineColor));a.sceneColor&&(a.sceneColor=C(a.sceneColor));a.skylineColor&&(a.skylineColor=C(a.skylineColor));a.backgroundColor&&(a.backgroundColor=C(a.backgroundColor));if(a.tileLayers){a.tileLayers=F(a.tileLayers);for(let c of a.tileLayers)c.hasOwnProperty("color")&&
(c.color=C(c.color))}a.command=p.Tools_StartSkylineAnalysis;return this.int.call(a,b)}stopSkylineAnalysis(a){return this.int.call0(p.Tools_StopSkylineAnalysis,a)}exportSkyline(a,b,c,e){c=c||{};c.skylineColor&&(c.skylineColor=C(c.skylineColor));c.backgroundColor&&(c.backgroundColor=C(c.backgroundColor));if(c.tileLayers){c.tileLayers=F(c.tileLayers);for(let d of c.tileLayer)d.hasOwnProperty("color")&&(d.color=C(d.color))}return this.int.call({command:p.Tools_ExportSkyline,path:a,size:b,skylineColor:c.skylineColor,
backgroundColor:c.backgroundColor},e)}startViewshedAnalysis(a,b){a=a||{};a.visibleColor&&(a.visibleColor=C(a.visibleColor));a.invisibleColor&&(a.invisibleColor=C(a.invisibleColor));a.command=p.Tools_StartViewshedAnalysis;return this.int.call(a,b)}stopViewshedAnalysis(a){return this.int.call0(p.Tools_StopViewshedAnalysis,a)}startVisiblityAnalysis(a,b){a=a||{};a.visibleColor&&(a.visibleColor=C(a.visibleColor));a.invisibleColor&&(a.invisibleColor=C(a.invisibleColor));a.command=p.Tools_StartVisiblityAnalysis;
return this.int.call(a,b)}stopVisiblityAnalysis(a){return this.int.call0(p.Tools_StopVisiblityAnalysis,a)}startViewDomeAnalysis(a,b){a=a||{};a.visibleColor&&(a.visibleColor=C(a.visibleColor));a.invisibleColor&&(a.invisibleColor=C(a.invisibleColor));a.command=p.Tools_StartViewDomeAnalysis;return this.int.call(a,b)}stopViewDomeAnalysis(a){return this.int.call0(p.Tools_StopViewDomeAnalysis,a)}startCutFillAnalysis(a,b){a=a||{};a.cutLineColor&&(a.cutLineColor=C(a.cutLineColor));a.fillLineColor&&(a.fillLineColor=
C(a.fillLineColor));a.cutPointColor&&(a.cutPointColor=C(a.cutPointColor));a.fillPointColor&&(a.fillPointColor=C(a.fillPointColor));a.gridColor&&(a.gridColor=C(a.gridColor));a.command=p.Tools_StartCutFillAnalysis;return this.int.call(a,b)}stopCutFillAnalysis(a){return this.int.call0(p.Tools_StopCutFillAnalysis,a)}startSunshineAnalysis(a,b){var c=/^(0?[0-9]|1[0-9]|[2][0-3]):(0?[0-9]|[1-5][0-9])$/;if(null==a||void 0==a)console.error("\u53c2\u6570\u4e0d\u80fd\u4e3a\u7a7a");else{let e=a.startTime,d=a.endTime;
...
return}if(a.startMinute>a.endMinute){console.error("\u5f00\u59cb\u65f6\u95f4\u4e0d\u80fd\u5927\u4e8e\u7ed3\u675f\u65f6\u95f4");return}}S(a.groundElevation)||(c=a.groundElevation,!isNaN(parseFloat(c))&&isFinite(c)&&(a.undersideHeight=a.groundElevation,delete a.groundElevation));a.command=p.Tools_StartSunshineAnalysis;return this.int.call(a,b)}else console.error("\u53c2\u6570endTime\u65f6\u95f4\u683c\u5f0f\u4e0d\u6b63\u786e");else console.error("\u53c2\u6570startTime\u65f6\u95f4\u683c\u5f0f\u4e0d\u6b63\u786e");
...
a)}startFloodFill(a,b){a=a||{};a.color&&(a.color=C(a.color));a.command=p.Tools_StartFloodFill;return this.int.call(a,b)}stopFloodFill(a){return this.int.call0(p.Tools_StopFloodFill,a)}replaceTextureByVideo(a,b,c){return this.int.call({command:p.Tools_ReplaceTexture,texturePackage:a,newTexture:b,type:1},c)}replaceTextureByImage(a,b,c){return this.int.call({command:p.Tools_ReplaceTexture,texturePackage:a,newTexture:b,type:2},c)}replaceTextureByUrl(a,b,c){return this.int.call({command:p.Tools_ReplaceTexture,
texturePackage:a,newTexture:b,type:3},c)}restoreTexture(a,b){return this.int.call({command:p.Tools_RestoreTexture,ids:F(a)},b)}showPanel(a,b,c){this.showAnalysisPanel(a,b,c)}hidePanel(a){this.hideAnalysisPanel(a)}showAnalysisPanel(a,b,c){return this.int.call({command:p.Tools_AnalysisPopupAttributes,type:a,position:b},c)}hideAnalysisPanel(a){return this.int.call({command:p.Tools_AnalysisCloseAttributes},a)}}class Yb{constructor(a){this.int=a}getParams(a){return this.int.call0(p.Weather_GetParams,a)}_setParam(a,
...
darkMode:!!a},b)}setSunSize(a,b){return this.int.call({command:p.Weather_SetParams,sunSize:a},b)}setMoonSize(a,b){return this.int.call({command:p.Weather_SetParams,moonSize:a},b)}}var va=null;class sa{constructor(a,b){va=this;this.isReady=!1;this.options=b||{};(this.player=this.options.player)||H.setLanguage();"function"==typeof sa.__onApiConstructed&&sa.__onApiConstructed(this);if(this.isCalledInCEF="object"==typeof ue&&"object"==typeof ue.internal)this.isReady=this.isConnected=!0;this.callbackMap=
new Map;this.websocket=null;this.callbackIndex=0;this.tickMarkerId="___tick_delegate_marker___";!this.player&&a&&(this.url=`ws://${a}`,this.connectWebSocket());this.apiQueue=new kb(c=>this.sendApi(c))}getPlayer(){return this.player}setHost(a,b){this.url=`ws://${a}:${b}`}connectWebSocket(){if(!this.player){this.log(`Connecting: ${this.url}`);if("undefined"==typeof window)this.websocket=new (require("ws"))(this.url);else{if(!("WebSocket"in window)){console.error("Not Support WebSocket!");return}this.websocket=
new WebSocket(this.url)}this.websocket.onopen=()=>this.onConnectionOpen();this.websocket.onmessage=a=>this.onConnectionMessage(a.data);this.websocket.onclose=a=>this.onConnectionClose(a);this.websocket.onerror=a=>this.onConnectionError(a)}}setEventCallback(a){this.options.onEvent=a}destroy(){this.isDestroyed=!0;this.player&&this.player.destroy();this.websocket&&(this.websocket.close(),this.websocket=null)}reset(a,b){return this.call({command:p.Reset,resetType:a||Aa.ClearObjects},b)}saveProject(a){return this.call0(p.SaveProject,
a)}registerTick(a,b,c){b=b||{};"__execute__"!=a&&(b.func="tick");this.call({command:p.RegisterJsCommunication,id:this.tickMarkerId,url:a,func:b.func,x:b.x||4,y:b.y||4,width:b.width||400,height:b.height||300,visible:b.visible||!1},c)}removeTick(a){this.call({command:p.UnRegisterJsCommunication,ids:[this.tickMarkerId]},a)}showTickWindow(a,b){this.isCalledInCEF?ue.internal.showtickwindow(a):a?this.registerTick("__show__",{},b):this.registerTick("",{},b)}executeJsInTickPage(a,b){this.registerTick("__execute__",
{func:a},b)}getVersion(){return"6.0.0305.17225"}checkApiReady(){if(!this.isReady)throw console.error("The interface call is not ready!"),"The interface call is not ready!";return!0}get camera(){if(!this.checkApiReady())return null;this._camera||(this._camera=new Qb(this));return this._camera}get coord(){if(!this.checkApiReady())return null;this._coord||(this._coord=new Rb(this));return this._coord}get infoTree(){if(!this.checkApiReady())return null;this._infoTree||(this._infoTree=new Tb(this));return this._infoTree}get cameraTour(){if(!this.checkApiReady())return null;
this._cameraTour||(this._cameraTour=new mb(this));return this._cameraTour}get tileLayer(){if(!this.checkApiReady())return null;this._tileLayer||(this._tileLayer=new Kb(this));return this._tileLayer}get tag(){if(!this.checkApiReady())return null;this._tag||(this._tag=new Jb(this));return this._tag}get marker(){if(!this.checkApiReady())return null;this._marker||(this._marker=new Ab(this));return this._marker}get marker3d(){if(!this.checkApiReady())return null;this._marker3d||(this._marker3d=new Bb(this));
return this._marker3d}get customTag(){if(!this.checkApiReady())return null;this._customTag||(this._customTag=new qb(this));return this._customTag}get radiationPoint(){if(!this.checkApiReady())return null;this._radiationPoint||(this._radiationPoint=new Hb(this));return this._radiationPoint}get customMesh(){if(!this.checkApiReady())return null;this._customMesh||(this._customMesh=new ob(this));return this._customMesh}get waterMesh(){if(!this.checkApiReady())return null;this._waterMesh||(this._waterMesh=
new Ob(this));return this._waterMesh}get waterFlowField(){if(!this.checkApiReady())return null;this._waterFlowField||(this._waterFlowField=new Nb(this));return this._waterFlowField}get polyline(){if(!this.checkApiReady())return null;this._polyline||(this._polyline=new Gb(this));return this._polyline}get odline(){if(!this.checkApiReady())return null;this._odline||(this._odline=new Cb(this));return this._odline}get polygon3d(){if(!this.checkApiReady())return null;this._polygon3d||(this._polygon3d=new Fb(this));
return this._polygon3d}get polygon(){if(!this.checkApiReady())return null;this._polygon||(this._polygon=new Eb(this));return this._polygon}get heatmap(){if(!this.checkApiReady())return null;this._heatmap||(this._heatmap=new vb(this));return this._heatmap}get heatmap3d(){if(!this.checkApiReady())return null;this._heatmap3d||(this._heatmap3d=new wb(this));return this._heatmap3d}get beam(){if(!this.checkApiReady())return null;this._beam||(this._beam=new lb(this));return this._beam}get highlightArea(){if(!this.checkApiReady())return null;
this._highlightArea||(this._highlightArea=new xb(this));return this._highlightArea}get customObject(){if(!this.checkApiReady())return null;this._customObject||(this._customObject=new pb(this));return this._customObject}get videoProjection(){if(!this.checkApiReady())return null;this._videoProjection||(this._videoProjection=new Mb(this));return this._videoProjection}get panorama(){if(!this.checkApiReady())return null;this._panorama||(this._panorama=new Db(this));return this._panorama}get decal(){if(!this.checkApiReady())return null;
this._decal||(this._decal=new rb(this));return this._decal}get dynamicWater(){if(!this.checkApiReady())return null;this._dynamicWater||(this._dynamicWater=new sb(this));return this._dynamicWater}get floodFill(){if(!this.checkApiReady())return null;this._floodFill||(this._floodFill=new tb(this));return this._floodFill}get cesium3DTileset(){if(!this.checkApiReady())return null;this._cesium3DTileset||(this._cesium3DTileset=new nb(this));return this._cesium3DTileset}get shapeFileLayer(){if(!this.checkApiReady())return null;
this._shapeFileLayer||(this._shapeFileLayer=new Ib(this));return this._shapeFileLayer}get light(){if(!this.checkApiReady())return null;this._light||(this._light=new zb(this));return this._light}get imageryLayer(){if(!this.checkApiReady())return null;this._imageryLayer||(this._imageryLayer=new yb(this));return this._imageryLayer}get geoJSONLayer(){if(!this.checkApiReady())return null;this._geoJSONLayer||(this._geoJSONLayer=new ub(this));return this._geoJSONLayer}get vehicle(){if(!this.checkApiReady())return null;
this._vehicle||(this._vehicle=new Lb(this));return this._vehicle}get misc(){if(!this.checkApiReady())return null;this._misc||(this._misc=new Ub(this));return this._misc}get tools(){if(!this.checkApiReady())return null;this._tools||(this._tools=new Xb(this));return this._tools}get settings(){if(!this.checkApiReady())return null;this._settings||(this._settings=new Vb(this));return this._settings}get weather(){if(!this.checkApiReady())return null;this._weather||(this._weather=new Yb(this));return this._weather}get editHelper(){if(!this.checkApiReady())return null;
this._editHelper||(this._editHelper=new Sb(this));return this._editHelper}get settingsPanel(){if(!this.checkApiReady())return null;this._settingsPanel||(this._settingsPanel=new Wb(this));return this._settingsPanel}get markerLayer(){if(!this.checkApiReady())return null;this._markerLayer||(this._markerLayer=new Pb(this));return this._markerLayer}setEnableAliases(){this.ct=this.cameraTour;this.tl=this.tileLayer;this.ctag=this.customTag;this.line=this.polyline;this.ol=this.odline;this.p3d=this.polygon3d;
this.hm=this.heatmap;this.hm3d=this.heatmap3d;this.co=this.customObject;this.ha=this.highlightArea;this.vp=this.videoProjection;this.dw=this.dynamicWater;this.ff=this.floodFill;this.c3d=this.cesium3DTileset;this.shapeFile=this.shp=this.shapeFileLayer;this.imagery=this.imageryLayer;this.geoJSON=this.geoJSONLayer;this.vc=this.vehicle;this.eh=this.editHelper;this.sp=this.settingsPanel}_getCallbackIndex(){return++this.callbackIndex}call0(a,b){return this.call({command:a},b)}call(a,b){if(!this.isConnected)return this.logWithColor("red",
...
break;case 2:this.camera.get(b=>this.savedCamera=b.camera)}}onReady(){this.isReady=!0;if("function"==typeof this.options.onReady)this.options.onReady();this.call({command:p.Misc_GetVersion});if(this.player)this.player.onApiReady()}log(a,b,c){if("function"==typeof this.options.onLog)this.options.onLog(a,b,c)}logWithColor(a,b,c){this.log(b,c,a)}onConnectionOpen(){this.isConnected=!0;this.logWithColor("blue","Connected!")}onConnectionClose(a){this.isConnected=!1;this.logWithColor("red",`Connection closed! code: ${a.code||
...
l.length&&(0===arguments.length||"function"!==typeof r))return l.apply(this,[]);var u=function(m){var n={};m.result().forEach(function(w){var z={id:w.id,timestamp:w.timestamp,type:{localcandidate:"local-candidate",remotecandidate:"remote-candidate"}[w.type]||w.type};w.names().forEach(function(B){z[B]=w.stat(B)});n[z.id]=z});return n},A=function(m){return new Map(Object.keys(m).map(function(n){return[n,m[n]]}))};return 2<=arguments.length?l.apply(this,[function(m){y(A(u(m)))},r]):(new Promise(function(m,
n){l.apply(t,[function(w){m(A(u(w)))},n])})).then(y,x)}}};c.shimSenderReceiverGetStats=function(f){if("object"===("undefined"===typeof f?"undefined":g(f))&&f.RTCPeerConnection&&f.RTCRtpSender&&f.RTCRtpReceiver){if(!("getStats"in f.RTCRtpSender.prototype)){var l=f.RTCPeerConnection.prototype.getSenders;l&&(f.RTCPeerConnection.prototype.getSenders=function(){var y=this,u=l.apply(this,[]);u.forEach(function(A){return A._pc=y});return u});var t=f.RTCPeerConnection.prototype.addTrack;t&&(f.RTCPeerConnection.prototype.addTrack=
function(){var y=t.apply(this,arguments);y._pc=this;return y});f.RTCRtpSender.prototype.getStats=function(){var y=this;return this._pc.getStats().then(function(u){return k.filterStats(u,y.track,!0)})}}if(!("getStats"in f.RTCRtpReceiver.prototype)){var x=f.RTCPeerConnection.prototype.getReceivers;x&&(f.RTCPeerConnection.prototype.getReceivers=function(){var y=this,u=x.apply(this,[]);u.forEach(function(A){return A._pc=y});return u});k.wrapPeerConnectionEvent(f,"track",function(y){y.receiver._pc=y.srcElement;
...
function(n,w){var z=this;if("closed"===this.signalingState)throw new DOMException("The RTCPeerConnection's signalingState is 'closed'.","InvalidStateError");var B=[].slice.call(arguments,1);if(1!==B.length||!B[0].getTracks().find(function(D){return D===n}))throw new DOMException("The adapter.js addTrack polyfill only supports a single  stream which is associated with the specified track.","NotSupportedError");if(this.getSenders().find(function(D){return D.track===n}))throw new DOMException("Track already exists.",
"InvalidAccessError");this._streams=this._streams||{};this._reverseStreams=this._reverseStreams||{};(B=this._streams[w.id])?(B.addTrack(n),Promise.resolve().then(function(){z.dispatchEvent(new Event("negotiationneeded"))})):(B=new f.MediaStream([n]),this._streams[w.id]=B,this._reverseStreams[B.id]=w,this.addStream(B));return this.getSenders().find(function(D){return D.track===n})};["createOffer","createAnswer"].forEach(function(n){var w=f.RTCPeerConnection.prototype[n],z=e({},n,function(){var B=this,
D=arguments;return arguments.length&&"function"===typeof arguments[0]?w.apply(this,[function(G){G=l(B,G);D[0].apply(null,[G])},function(G){D[1]&&D[1].apply(null,G)},arguments[2]]):w.apply(this,arguments).then(function(G){return l(B,G)})});f.RTCPeerConnection.prototype[n]=z[n]});var A=f.RTCPeerConnection.prototype.setLocalDescription;f.RTCPeerConnection.prototype.setLocalDescription=function(){if(!arguments.length||!arguments[0].type)return A.apply(this,arguments);arguments[0]=t(this,arguments[0]);
...
"TypeError");if(n._pc!==this)throw new DOMException("Sender was not created by this connection.","InvalidAccessError");this._streams=this._streams||{};var z=void 0;Object.keys(this._streams).forEach(function(B){w._streams[B].getTracks().find(function(D){return n.track===D})&&(z=w._streams[B])});z&&(1===z.getTracks().length?this.removeStream(this._reverseStreams[z.id]):z.removeTrack(n.track),this.dispatchEvent(new Event("negotiationneeded")))}}};c.shimPeerConnection=function(f){var l=k.detectBrowser(f);
...
"mediaSource"!==u){var A="object"===e(r[u])?r[u]:{ideal:r[u]};void 0!==A.exact&&"number"===typeof A.exact&&(A.min=A.max=A.exact);var m=function(w,z){return w?w+z.charAt(0).toUpperCase()+z.slice(1):"deviceId"===z?"sourceId":z};if(void 0!==A.ideal){y.optional=y.optional||[];var n={};"number"===typeof A.ideal?(n[m("min",u)]=A.ideal,y.optional.push(n),n={},n[m("max",u)]=A.ideal):n[m("",u)]=A.ideal;y.optional.push(n)}void 0!==A.exact&&"number"!==typeof A.exact?(y.mandatory=y.mandatory||{},y.mandatory[m("",
u)]=A.exact):["min","max"].forEach(function(w){void 0!==A[w]&&(y.mandatory=y.mandatory||{},y.mandatory[m(w,u)]=A[w])})}});r.advanced&&(y.optional=(y.optional||[]).concat(r.advanced));return y},l=function(r,y){if(61<=k.version)return y(r);if((r=JSON.parse(JSON.stringify(r)))&&"object"===e(r.audio)){var u=function(n,w,z){w in n&&!(z in n)&&(n[z]=n[w],delete n[w])};r=JSON.parse(JSON.stringify(r));u(r.audio,"autoGainControl","googAutoGainControl");u(r.audio,"noiseSuppression","googNoiseSuppression");
...
toString:function(){return this.name+(this.message&&": ")+this.message}}};q.getUserMedia=function(r,y,u){l(r,function(A){q.webkitGetUserMedia(A,y,function(m){u&&u(t(m))})})}.bind(q);if(q.mediaDevices.getUserMedia){var x=q.mediaDevices.getUserMedia.bind(q.mediaDevices);q.mediaDevices.getUserMedia=function(r){return l(r,function(y){return x(y).then(function(u){if(y.audio&&!u.getAudioTracks().length||y.video&&!u.getVideoTracks().length)throw u.getTracks().forEach(function(A){A.stop()}),new DOMException("",
...
q.browser&&(y=57>q.version?-1===r?16384:2147483637:60>q.version?57===q.version?65535:65536:2147483637);return y},t=function(r,y){var u=65536;"firefox"===q.browser&&57===q.version&&(u=65535);r=d.default.matchPrefix(r.sdp,"a=max-message-size:");0<r.length?u=parseInt(r[0].substr(19),10):"firefox"===q.browser&&-1!==y&&(u=2147483637);return u},x=h.RTCPeerConnection.prototype.setRemoteDescription;h.RTCPeerConnection.prototype.setRemoteDescription=function(){this._sctp=null;"chrome"===q.browser&&76<=q.version&&
"plan-b"===this.getConfiguration().sdpSemantics&&Object.defineProperty(this,"sctp",{get:function(){return"undefined"===typeof this._sctp?null:this._sctp},enumerable:!0,configurable:!0});if(k(arguments[0])){var r=f(arguments[0]),y=l(r);r=t(arguments[0],r);var u=void 0;u=0===y&&0===r?Number.POSITIVE_INFINITY:0===y||0===r?Math.max(y,r):Math.min(y,r);y={};Object.defineProperty(y,"maxMessageSize",{get:function(){return u}});this._sctp=y}return x.apply(this,arguments)}}};c.shimSendThrowTypeError=function(h){function q(f,
l){var t=f.send;f.send=function(){var x=arguments[0];x=x.length||x.size||x.byteLength;if("open"===f.readyState&&l.sctp&&x>l.sctp.maxMessageSize)throw new TypeError("Message too large (can send a maximum of "+l.sctp.maxMessageSize+" bytes)");return t.apply(f,arguments)}}if(h.RTCPeerConnection&&"createDataChannel"in h.RTCPeerConnection.prototype){var k=h.RTCPeerConnection.prototype.createDataChannel;h.RTCPeerConnection.prototype.createDataChannel=function(){var f=k.apply(this,arguments);q(f,this);return f};
...
[];var l=arguments[1],t=l&&"sendEncodings"in l;t&&l.sendEncodings.forEach(function(y){if("rid"in y&&!/^[a-z0-9]{0,16}$/i.test(y.rid))throw new TypeError("Invalid RID value provided.");if("scaleResolutionDownBy"in y&&!(1<=parseFloat(y.scaleResolutionDownBy)))throw new RangeError("scale_resolution_down_by must be >= 1.0");if("maxFramerate"in y&&!(0<=parseFloat(y.maxFramerate)))throw new RangeError("max_framerate must be >= 0.0");});var x=f.apply(this,arguments);if(t){var r=x.sender;t=r.getParameters();
"encodings"in t||(t.encodings=l.sendEncodings,r.sendEncodings=l.sendEncodings,this.setParametersPromises.push(r.setParameters(t).then(function(){delete r.sendEncodings}).catch(function(){delete r.sendEncodings})))}return x})}};c.shimGetParameters=function(k){if("object"===("undefined"===typeof k?"undefined":d(k))&&k.RTCRtpSender){var f=k.RTCRtpSender.prototype.getParameters;f&&(k.RTCRtpSender.prototype.getParameters=function(){var l=f.apply(this,arguments);return"sendEncodings"in this?Object.assign({},
...
(x=JSON.parse(JSON.stringify(x)),k(x.audio,"autoGainControl","mozAutoGainControl"),k(x.audio,"noiseSuppression","mozNoiseSuppression"));return f(x)};if(g&&g.prototype.getSettings){var l=g.prototype.getSettings;g.prototype.getSettings=function(){var x=l.apply(this,arguments);k(x,"mozAutoGainControl","autoGainControl");k(x,"mozNoiseSuppression","noiseSuppression");return x}}if(g&&g.prototype.applyConstraints){var t=g.prototype.applyConstraints;g.prototype.applyConstraints=function(x){"audio"===this.kind&&
"object"===("undefined"===typeof x?"undefined":e(x))&&(x=JSON.parse(JSON.stringify(x)),k(x,"autoGainControl","mozAutoGainControl"),k(x,"noiseSuppression","mozNoiseSuppression"));return t.apply(this,[x])}}}};var d=function(g){if(g&&g.__esModule)return g;var h={};if(null!=g)for(var q in g)Object.prototype.hasOwnProperty.call(g,q)&&(h[q]=g[q]);h.default=g;return h}(a("../utils"))},{"../utils":15}],14:[function(a,b,c){function e(h){return h&&void 0!==h.video?Object.assign({},h,{video:g.compactObject(h.video)}):
...
l=arguments.length,t=Array(1<l?l-1:0),x=1;x<l;x++)t[x-1]=arguments[x];t&&t.forEach(function(r){f._localStreams?f._localStreams.includes(r)||f._localStreams.push(r):f._localStreams=[r]});return q.apply(this,arguments)}}"removeStream"in h.RTCPeerConnection.prototype||(h.RTCPeerConnection.prototype.removeStream=function(k){var f=this;this._localStreams||(this._localStreams=[]);var l=this._localStreams.indexOf(k);if(-1!==l){this._localStreams.splice(l,1);var t=k.getTracks();this.getSenders().forEach(function(x){t.includes(x.track)&&
...
f=h.setLocalDescription,l=h.setRemoteDescription,t=h.addIceCandidate;h.createOffer=function(r,y){var u=q.apply(this,[2<=arguments.length?arguments[2]:arguments[0]]);if(!y)return u;u.then(r,y);return Promise.resolve()};h.createAnswer=function(r,y){var u=k.apply(this,[2<=arguments.length?arguments[2]:arguments[0]]);if(!y)return u;u.then(r,y);return Promise.resolve()};var x=function(r,y,u){r=f.apply(this,[r]);if(!u)return r;r.then(y,u);return Promise.resolve()};h.setLocalDescription=x;x=function(r,y,
u){r=l.apply(this,[r]);if(!u)return r;r.then(y,u);return Promise.resolve()};h.setRemoteDescription=x;x=function(r,y,u){r=t.apply(this,[r]);if(!u)return r;r.then(y,u);return Promise.resolve()};h.addIceCandidate=x}};c.shimGetUserMedia=function(h){var q=h&&h.navigator;if(q.mediaDevices&&q.mediaDevices.getUserMedia){h=q.mediaDevices;var k=h.getUserMedia.bind(h);q.mediaDevices.getUserMedia=function(f){return k(e(f))}}!q.getUserMedia&&q.mediaDevices&&q.mediaDevices.getUserMedia&&(q.getUserMedia=function(f,
l,t){q.mediaDevices.getUserMedia(f).then(l,t)}.bind(q))};c.shimConstraints=e;c.shimRTCIceServerUrls=function(h){var q=h.RTCPeerConnection;h.RTCPeerConnection=function(k,f){if(k&&k.iceServers){for(var l=[],t=0;t<k.iceServers.length;t++){var x=k.iceServers[t];!x.hasOwnProperty("urls")&&x.hasOwnProperty("url")?(g.deprecated("RTCIceServer.url","RTCIceServer.urls"),x=JSON.parse(JSON.stringify(x)),x.urls=x.url,delete x.url,l.push(x)):l.push(k.iceServers[t])}k.iceServers=l}return new q(k,f)};h.RTCPeerConnection.prototype=
...
function g(l,t){var x={codecs:[],headerExtensions:[],fecMechanisms:[]},r=function(u,A){u=parseInt(u,10);for(var m=0;m<A.length;m++)if(A[m].payloadType===u||A[m].preferredPayloadType===u)return A[m]},y=function(u,A,m,n){u=r(u.parameters.apt,m);A=r(A.parameters.apt,n);return u&&A&&u.name.toLowerCase()===A.name.toLowerCase()};l.codecs.forEach(function(u){for(var A=0;A<t.codecs.length;A++){var m=t.codecs[A];if(u.name.toLowerCase()===m.name.toLowerCase()&&u.clockRate===m.clockRate&&("rtx"!==u.name.toLowerCase()||
!u.parameters||!m.parameters.apt||y(u,m,l.codecs,t.codecs))){m=JSON.parse(JSON.stringify(m));m.numChannels=Math.min(u.numChannels,m.numChannels);x.codecs.push(m);m.rtcpFeedback=m.rtcpFeedback.filter(function(n){for(var w=0;w<u.rtcpFeedback.length;w++)if(u.rtcpFeedback[w].type===n.type&&u.rtcpFeedback[w].parameter===n.parameter)return!0;return!1});break}}});l.headerExtensions.forEach(function(u){for(var A=0;A<t.headerExtensions.length;A++){var m=t.headerExtensions[A];if(u.uri===m.uri){x.headerExtensions.push(m);
break}}});return x}function h(l,t,x){return-1!=={offer:{setLocalDescription:["stable","have-local-offer"],setRemoteDescription:["stable","have-remote-offer"]},answer:{setLocalDescription:["have-remote-offer","have-local-pranswer"],setRemoteDescription:["have-local-offer","have-remote-pranswer"]}}[t][l].indexOf(x)}function q(l,t){var x=l.getRemoteCandidates().find(function(r){return t.foundation===r.foundation&&t.ip===r.ip&&t.port===r.port&&t.priority===r.priority&&t.protocol===r.protocol&&t.type===
r.type});x||l.addRemoteCandidate(t);return!x}function k(l,t){t=Error(t);t.name=l;t.code={NotSupportedError:9,InvalidStateError:11,InvalidAccessError:15,TypeError:void 0,OperationError:void 0}[l];return t}var f=a("sdp");b.exports=function(l,t){function x(m,n){n.addTrack(m);n.dispatchEvent(new l.MediaStreamTrackEvent("addtrack",{track:m}))}function r(m,n){n.removeTrack(m);n.dispatchEvent(new l.MediaStreamTrackEvent("removetrack",{track:m}))}function y(m,n,w,z){var B=new Event("track");B.track=n;B.receiver=
...
this.localStreams.push(n);w.track=m;w.stream=n;w.rtpSender=new l.RTCRtpSender(m,w.dtlsTransport);return w.rtpSender};u.prototype.addStream=function(m){var n=this;if(15025<=t)m.getTracks().forEach(function(z){n.addTrack(z,m)});else{var w=m.clone();m.getTracks().forEach(function(z,B){var D=w.getTracks()[B];z.addEventListener("enabled",function(G){D.enabled=G.enabled})});w.getTracks().forEach(function(z){n.addTrack(z,w)})}};u.prototype.removeTrack=function(m){if(this._isClosed)throw k("InvalidStateError",
...
u.prototype._createIceGatherer=function(m,n){var w=this;if(n&&0<m)return this.transceivers[0].iceGatherer;if(this._iceGatherers.length)return this._iceGatherers.shift();var z=new l.RTCIceGatherer({iceServers:this._config.iceServers,gatherPolicy:this._config.iceTransportPolicy});Object.defineProperty(z,"state",{value:"new",writable:!0});this.transceivers[m].bufferedCandidateEvents=[];this.transceivers[m].bufferCandidates=function(B){var D=!B.candidate||0===Object.keys(B.candidate).length;z.state=D?
...
n._isClosed)return Promise.reject(k("InvalidStateError","Can not set local "+m.type+" in state "+n.signalingState));if("offer"===m.type){var w=f.splitSections(m.sdp);var z=w.shift();w.forEach(function(D,G){D=f.parseRtpParameters(D);n.transceivers[G].localCapabilities=D});n.transceivers.forEach(function(D,G){n._gather(D.mid,G)})}else if("answer"===m.type){w=f.splitSections(n._remoteDescription.sdp);z=w.shift();var B=0<f.matchPrefix(z,"a=ice-lite").length;w.forEach(function(D,G){var M=n.transceivers[G],
Z=M.iceGatherer,L=M.iceTransport,J=M.dtlsTransport,Q=M.localCapabilities,T=M.remoteCapabilities;if(!(f.isRejected(D)&&0===f.matchPrefix(D,"a=bundle-only").length||M.rejected)){var aa=f.getIceParameters(D,z);D=f.getDtlsParameters(D,z);B&&(D.role="server");n.usingBundle&&0!==G||(n._gather(M.mid,G),"new"===L.state&&L.start(Z,aa,B?"controlling":"controlled"),"new"===J.state&&J.start(D));G=g(Q,T);n._transceive(M,0<G.codecs.length,!1)}})}n._localDescription={type:m.type,sdp:m.sdp};"offer"===m.type?n._updateSignalingState("have-local-offer"):
n._updateSignalingState("stable");return Promise.resolve()};u.prototype.setRemoteDescription=function(m){var n=this;if(-1===["offer","answer"].indexOf(m.type))return Promise.reject(k("TypeError",'Unsupported type "'+m.type+'"'));if(!h("setRemoteDescription",m.type,n.signalingState)||n._isClosed)return Promise.reject(k("InvalidStateError","Can not set remote "+m.type+" in state "+n.signalingState));var w={};n.remoteStreams.forEach(function(L){w[L.id]=L});var z=[],B=f.splitSections(m.sdp),D=B.shift(),
G=0<f.matchPrefix(D,"a=ice-lite").length,M=0<f.matchPrefix(D,"a=group:BUNDLE ").length;n.usingBundle=M;var Z=f.matchPrefix(D,"a=ice-options:")[0];n.canTrickleIceCandidates=Z?0<=Z.substr(14).split(" ").indexOf("trickle"):!1;B.forEach(function(L,J){var Q=f.splitLines(L),T=f.getKind(L),aa=f.isRejected(L)&&0===f.matchPrefix(L,"a=bundle-only").length,ma=Q[0].substr(2).split(" ")[2];Q=f.getDirection(L,D);var X=f.parseMsid(L),oa=f.getMid(L)||f.generateIdentifier();if(aa||"application"===T&&("DTLS/SCTP"===
ma||"UDP/DTLS/SCTP"===ma))n.transceivers[J]={mid:oa,kind:T,protocol:ma,rejected:!0};else{!aa&&n.transceivers[J]&&n.transceivers[J].rejected&&(n.transceivers[J]=n._createTransceiver(T,!0));var Da=f.parseRtpParameters(L);if(!aa){var pa=f.getIceParameters(L,D);var Ea=f.getDtlsParameters(L,D);Ea.role="client"}ma=f.parseRtpEncodingParameters(L);var Fa=f.parseRtcpParameters(L),Ga=0<f.matchPrefix(L,"a=end-of-candidates",D).length,na=f.matchPrefix(L,"a=candidate:").map(function(Y){return f.parseCandidate(Y)}).filter(function(Y){return 1===
Y.component});("offer"===m.type||"answer"===m.type)&&!aa&&M&&0<J&&n.transceivers[J]&&(n._disposeIceAndDtlsTransports(J),n.transceivers[J].iceGatherer=n.transceivers[0].iceGatherer,n.transceivers[J].iceTransport=n.transceivers[0].iceTransport,n.transceivers[J].dtlsTransport=n.transceivers[0].dtlsTransport,n.transceivers[J].rtpSender&&n.transceivers[J].rtpSender.setTransport(n.transceivers[0].dtlsTransport),n.transceivers[J].rtpReceiver&&n.transceivers[J].rtpReceiver.setTransport(n.transceivers[0].dtlsTransport));
if("offer"!==m.type||aa)"answer"!==m.type||aa||(N=n.transceivers[J],ja=N.iceGatherer,T=N.iceTransport,oa=N.dtlsTransport,ha=N.rtpReceiver,aa=N.sendEncodingParameters,L=N.localCapabilities,n.transceivers[J].recvEncodingParameters=ma,n.transceivers[J].remoteCapabilities=Da,n.transceivers[J].rtcpParameters=Fa,na.length&&"new"===T.state&&(!G&&!Ga||M&&0!==J?na.forEach(function(Y){q(N.iceTransport,Y)}):T.setRemoteCandidates(na)),M&&0!==J||("new"===T.state&&T.start(ja,pa,"controlling"),"new"===oa.state&&
oa.start(Ea)),!g(N.localCapabilities,N.remoteCapabilities).codecs.filter(function(Y){return"rtx"===Y.name.toLowerCase()}).length&&N.sendEncodingParameters[0].rtx&&delete N.sendEncodingParameters[0].rtx,n._transceive(N,"sendrecv"===Q||"recvonly"===Q,"sendrecv"===Q||"sendonly"===Q),!ha||"sendrecv"!==Q&&"sendonly"!==Q?delete N.rtpReceiver:(Q=ha.track,X?(w[X.stream]||(w[X.stream]=new l.MediaStream),x(Q,w[X.stream]),z.push([Q,ha,w[X.stream]])):(w.default||(w.default=new l.MediaStream),x(Q,w.default),z.push([Q,
ha,w.default]))));else{var N=n.transceivers[J]||n._createTransceiver(T);N.mid=oa;N.iceGatherer||(N.iceGatherer=n._createIceGatherer(J,M));na.length&&"new"===N.iceTransport.state&&(!Ga||M&&0!==J?na.forEach(function(Y){q(N.iceTransport,Y)}):N.iceTransport.setRemoteCandidates(na));L=l.RTCRtpReceiver.getCapabilities(T);15019>t&&(L.codecs=L.codecs.filter(function(Y){return"rtx"!==Y.name}));aa=N.sendEncodingParameters||[{ssrc:1001*(2*J+2)}];pa=!1;if("sendrecv"===Q||"sendonly"===Q){pa=!N.rtpReceiver;var ha=
N.rtpReceiver||new l.RTCRtpReceiver(N.dtlsTransport,T);if(pa){Q=ha.track;if(!X||"-"!==X.stream)if(X){w[X.stream]||(w[X.stream]=new l.MediaStream,Object.defineProperty(w[X.stream],"id",{get:function(){return X.stream}}));Object.defineProperty(Q,"id",{get:function(){return X.track}});var ja=w[X.stream]}else w.default||(w.default=new l.MediaStream),ja=w.default;ja&&(x(Q,ja),N.associatedRemoteMediaStreams.push(ja));z.push([Q,ha,ja])}}else N.rtpReceiver&&N.rtpReceiver.track&&(N.associatedRemoteMediaStreams.forEach(function(Y){var Ha=
Y.getTracks().find(function(ac){return ac.id===N.rtpReceiver.track.id});Ha&&r(Ha,Y)}),N.associatedRemoteMediaStreams=[]);N.localCapabilities=L;N.remoteCapabilities=Da;N.rtpReceiver=ha;N.rtcpParameters=Fa;N.sendEncodingParameters=aa;N.recvEncodingParameters=ma;n._transceive(n.transceivers[J],!1,pa)}}});void 0===n._dtlsRole&&(n._dtlsRole="offer"===m.type?"active":"passive");n._remoteDescription={type:m.type,sdp:m.sdp};"offer"===m.type?n._updateSignalingState("have-remote-offer"):n._updateSignalingState("stable");
Object.keys(w).forEach(function(L){var J=w[L];if(J.getTracks().length){if(-1===n.remoteStreams.indexOf(J)){n.remoteStreams.push(J);var Q=new Event("addstream");Q.stream=J;l.setTimeout(function(){n._dispatchEvent("addstream",Q)})}z.forEach(function(T){J.id===T[2].id&&y(n,T[0],T[1],[J])})}});z.forEach(function(L){L[2]||y(n,L[0],L[1],[])});l.setTimeout(function(){n&&n.transceivers&&n.transceivers.forEach(function(L){L.iceTransport&&"new"===L.iceTransport.state&&0<L.iceTransport.getRemoteCandidates().length&&
...
function(m){var n=this;if(n._isClosed)return Promise.reject(k("InvalidStateError","Can not call createOffer after close"));var w=n.transceivers.filter(function(D){return"audio"===D.kind}).length,z=n.transceivers.filter(function(D){return"video"===D.kind}).length;if(m){if(m.mandatory||m.optional)throw new TypeError("Legacy mandatory/optional constraints not supported.");void 0!==m.offerToReceiveAudio&&(w=!0===m.offerToReceiveAudio?1:!1===m.offerToReceiveAudio?0:m.offerToReceiveAudio);void 0!==m.offerToReceiveVideo&&
(z=!0===m.offerToReceiveVideo?1:!1===m.offerToReceiveVideo?0:m.offerToReceiveVideo)}for(n.transceivers.forEach(function(D){"audio"===D.kind?(w--,0>w&&(D.wantReceive=!1)):"video"===D.kind&&(z--,0>z&&(D.wantReceive=!1))});0<w||0<z;)0<w&&(n._createTransceiver("audio"),w--),0<z&&(n._createTransceiver("video"),z--);var B=f.writeSessionBoilerplate(n._sdpSessionId,n._sdpSessionVersion++);n.transceivers.forEach(function(D,G){var M=D.track,Z=D.kind,L=D.mid||f.generateIdentifier();D.mid=L;D.iceGatherer||(D.iceGatherer=
n._createIceGatherer(G,n.usingBundle));L=l.RTCRtpSender.getCapabilities(Z);15019>t&&(L.codecs=L.codecs.filter(function(J){return"rtx"!==J.name}));L.codecs.forEach(function(J){"H264"===J.name&&void 0===J.parameters["level-asymmetry-allowed"]&&(J.parameters["level-asymmetry-allowed"]="1");D.remoteCapabilities&&D.remoteCapabilities.codecs&&D.remoteCapabilities.codecs.forEach(function(Q){J.name.toLowerCase()===Q.name.toLowerCase()&&J.clockRate===Q.clockRate&&(J.preferredPayloadType=Q.payloadType)})});
L.headerExtensions.forEach(function(J){(D.remoteCapabilities&&D.remoteCapabilities.headerExtensions||[]).forEach(function(Q){J.uri===Q.uri&&(J.id=Q.id)})});G=D.sendEncodingParameters||[{ssrc:1001*(2*G+1)}];M&&15019<=t&&"video"===Z&&!G[0].rtx&&(G[0].rtx={ssrc:G[0].ssrc+1});D.wantReceive&&(D.rtpReceiver=new l.RTCRtpReceiver(D.dtlsTransport,Z));D.localCapabilities=L;D.sendEncodingParameters=G});"max-compat"!==n._config.bundlePolicy&&(B+="a=group:BUNDLE "+n.transceivers.map(function(D){return D.mid}).join(" ")+
"\r\n");B+="a=ice-options:trickle\r\n";n.transceivers.forEach(function(D,G){B+=e(D,D.localCapabilities,"offer",D.stream,n._dtlsRole);B+="a=rtcp-rsize\r\n";!D.iceGatherer||"new"===n.iceGatheringState||0!==G&&n.usingBundle||(D.iceGatherer.getLocalCandidates().forEach(function(M){M.component=1;B+="a="+f.writeCandidate(M)+"\r\n"}),"completed"===D.iceGatherer.state&&(B+="a=end-of-candidates\r\n"))});m=new l.RTCSessionDescription({type:"offer",sdp:B});return Promise.resolve(m)};u.prototype.createAnswer=
...
var w=f.getMediaSections(m._remoteDescription.sdp).length;m.transceivers.forEach(function(B,D){if(!(D+1>w))if(B.rejected)"application"===B.kind?n="DTLS/SCTP"===B.protocol?n+"m=application 0 DTLS/SCTP 5000\r\n":n+("m=application 0 "+B.protocol+" webrtc-datachannel\r\n"):"audio"===B.kind?n+="m=audio 0 UDP/TLS/RTP/SAVPF 0\r\na=rtpmap:0 PCMU/8000\r\n":"video"===B.kind&&(n+="m=video 0 UDP/TLS/RTP/SAVPF 120\r\na=rtpmap:120 VP8/90000\r\n"),n+="c=IN IP4 0.0.0.0\r\na=inactive\r\na=mid:"+B.mid+"\r\n";else{if(B.stream){var G;
"audio"===B.kind?G=B.stream.getAudioTracks()[0]:"video"===B.kind&&(G=B.stream.getVideoTracks()[0]);G&&15019<=t&&"video"===B.kind&&!B.sendEncodingParameters[0].rtx&&(B.sendEncodingParameters[0].rtx={ssrc:B.sendEncodingParameters[0].ssrc+1})}D=g(B.localCapabilities,B.remoteCapabilities);!D.codecs.filter(function(M){return"rtx"===M.name.toLowerCase()}).length&&B.sendEncodingParameters[0].rtx&&delete B.sendEncodingParameters[0].rtx;n+=e(B,D,"answer",B.stream,m._dtlsRole);B.rtcpParameters&&B.rtcpParameters.reducedSize&&
(n+="a=rtcp-rsize\r\n")}});var z=new l.RTCSessionDescription({type:"answer",sdp:n});return Promise.resolve(z)};u.prototype.addIceCandidate=function(m){var n=this,w;return m&&void 0===m.sdpMLineIndex&&!m.sdpMid?Promise.reject(new TypeError("sdpMLineIndex or sdpMid required")):new Promise(function(z,B){if(n._remoteDescription)if(m&&""!==m.candidate){var D=m.sdpMLineIndex;if(m.sdpMid)for(var G=0;G<n.transceivers.length;G++)if(n.transceivers[G].mid===m.sdpMid){D=G;break}var M=n.transceivers[D];if(M){if(M.rejected)return z();
G=0<Object.keys(m.candidate).length?f.parseCandidate(m.candidate):{};if("tcp"===G.protocol&&(0===G.port||9===G.port)||G.component&&1!==G.component)return z();if((0===D||0<D&&M.iceTransport!==n.transceivers[0].iceTransport)&&!q(M.iceTransport,G))return B(k("OperationError","Can not add ICE candidate"));B=m.candidate.trim();0===B.indexOf("a=")&&(B=B.substr(2));w=f.getMediaSections(n._remoteDescription.sdp);w[D]+="a="+(G.type?B:"end-of-candidates")+"\r\n";n._remoteDescription.sdp=f.getDescription(n._remoteDescription.sdp)+
w.join("")}else return B(k("OperationError","Can not add ICE candidate"))}else for(D=0;D<n.transceivers.length&&(n.transceivers[D].rejected||(n.transceivers[D].iceTransport.addRemoteCandidate({}),w=f.getMediaSections(n._remoteDescription.sdp),w[D]+="a=end-of-candidates\r\n",n._remoteDescription.sdp=f.getDescription(n._remoteDescription.sdp)+w.join(""),!n.usingBundle));D++);else return B(k("InvalidStateError","Can not add ICE candidate without a remote description"));z()})};u.prototype.getStats=function(m){if(m&&
...
G)})});return B})};["RTCRtpSender","RTCRtpReceiver","RTCIceGatherer","RTCIceTransport","RTCDtlsTransport"].forEach(function(m){if((m=l[m])&&m.prototype&&m.prototype.getStats){var n=m.prototype.getStats;m.prototype.getStats=function(){return n.apply(this).then(function(w){var z=new Map;Object.keys(w).forEach(function(B){var D=w[B];w[B].type={inboundrtp:"inbound-rtp",outboundrtp:"outbound-rtp",candidatepair:"candidate-pair",localcandidate:"local-candidate",remotecandidate:"remote-candidate"}[D.type]||
...
JSON.parse(JSON.stringify(r)),r.fec={ssrc:l,mechanism:k?"red+ulpfec":"red"},g.push(r)))});0===g.length&&l&&g.push({ssrc:l});var x=e.matchPrefix(d,"b=");x.length&&(x=0===x[0].indexOf("b=TIAS:")?parseInt(x[0].substr(7),10):0===x[0].indexOf("b=AS:")?950*parseInt(x[0].substr(5),10)-16E3:void 0,g.forEach(function(r){r.maxBitrate=x}));return g};e.parseRtcpParameters=function(d){var g={},h=e.matchPrefix(d,"a=ssrc:").map(function(q){return e.parseSsrcMedia(q)}).filter(function(q){return"cname"===q.attribute})[0];
...
this.setNeedReposUI()}removeElement(a){this.container.removeChild(a)}get(a){return xa(a+"_"+this.uniqueId)}getValue(a){let b;return null==(b=this.get(a))?void 0:b.value}setValue(a,b){(a=this.get(a))&&(a.value=b)}setText(a,b){(a=this.get(a))&&(a.innerText=b)}setHtml(a,b){(a=this.get(a))&&(a.innerHTML=b)}resize(){this.player.resize()}setNeedReposUI(){this.player.bNeedReposUI=!0}}class dc extends ia{constructor(a){super(a);this.el=document.createElement("pre");this.el.id="eventsPanel_"+this.uniqueId;
...
Shift:16,Control:17,Alt:18,RightShift:253,RightControl:254,RightAlt:255};class fc extends ia{constructor(a,b){super(a);this.video=null;this.useBuiltinCursors=b.useBuiltinCursors;this.keyEventTargetStr=b.keyEventTarget;this.keyEventTarget="document"==b.keyEventTarget?document:"none"==b.keyEventTarget?null:"video";this.callOnUserInteraction=()=>this.player.resetInteractTimestamp();this.fakeMouseWithTouches=!1;this.onMButtonDoubleClick=b.onMButtonDoubleClick;this.mouseKeyListener=b.mouseKeyListener;
this.touchListener=b.touchListener;this.onActionEnable=!0;this.onEvents=b.onEvents;this.onVideoLoaded=b.onVideoLoaded;this.orientationChangeTimeout=void 0;this.create()}registerEvents(){document.addEventListener("WeixinJSBridgeReady",()=>{R.isInWeixinBrowser=!0;this.video.play()});window.addEventListener("orientationchange",()=>{clearTimeout(this.orientationChangeTimeout);this.orientationChangeTimeout=setTimeout(()=>this.player.resize(),500)});this.registerKeyboardEvents();this.registerMouseEvents();
...
b.length);a=2;let e=[],d=this.video.getBoundingClientRect();for(let g of b){let h=g.clientX-d.left,q=g.clientY-d.top,k=this.normalizeAndQuantizeUnsigned(h,q),f=this.fingerIds[g.identifier];if(void 0==f){let l;null==(l=this.onEvents)||l.call(this,`\tError! Invalid: ${g.identifier}, ${JSON.stringify(this.fingerIds)} ${JSON.stringify(this.fingers)}, count:${b.length}`)}else c.setUint16(a,k.x,!0),a+=2,c.setUint16(a,k.y,!0),a+=2,c.setInt32(a,f,!0),a+=4,c.setUint8(a,255*g.force,!0),a+=1,c.setUint8(a,k.inRange?
1:0,!0),a+=1,e.push(`{${f} (${parseInt(h)},${parseInt(q)})->(${parseInt(k.x)},${parseInt(k.y)})}`)}this.rtc.send(c.buffer)}sendKeydown(a){this.callOnUserInteraction();let b=ya(a),c;null==(c=this.onEvents)||c.call(this,`Send KeyDown, Code:${b}, Repeat:${a.repeat}`);this.rtc.send((new Uint8Array([60,b,a.repeat])).buffer)}sendKeyup(a){this.callOnUserInteraction();a=ya(a);let b;null==(b=this.onEvents)||b.call(this,`Send KeyUp:${a}`);this.rtc.send((new Uint8Array([61,a])).buffer)}sendKeypress(a){this.callOnUserInteraction();
...
b);return[a,b]}}}destroy(a){console.log(`call DigitalTwinPlayer.destroy: ${a||" "}`);if(!this.isDestroyed){wa--;this.isDestroyed=!0;this.destroyReason=a;var b;null==(b=this.rtc)||b.close();var c;null==(c=this.signallingConnection)||c.close()}}setKeyEventTarget(a){let b;null==(b=this.htmlVideo)||b.setKeyEventTarget(a)}setKeyEventReceiver(a){this.setKeyEventTarget(a)}resize(){if(this.container){this.rect=this.container.getBoundingClientRect();if(this.bNeedReposUI||!this.oldRect||this.oldRect.width!=
this.rect.width||this.oldRect.height!=this.rect.height){this.bNeedReposUI=!1;this.oldRect=this.rect;let b;null==(b=this.eventsPanel)||b.setPosition(this.rect);let c;null==(c=this.startupInfo)||c.setPosition(this.rect);let e;null==(e=this.liveStatus)||e.setPosition(this.rect);let d;null==(d=this.fullscreenButton)||d.setPosition(this.rect,this.options.ui.statusButton);let g;null==(g=this.homeButton)||g.setPosition(this.rect,this.options.ui.statusButton,this.options.ui.fullscreenButton);let h;null==
(h=this.taskListBar)||h.setPosition(this.rect,this.options.ui.statusButton,this.options.ui.fullscreenButton,this.options.ui.homeButton)}if(this.htmlVideo.valid()){this.canAdaptiveResolution&&this.setResolution(this.htmlVideo.clientWidth(),this.htmlVideo.clientHeight());var a;null==(a=this.htmlVideo)||a.resize(this.streamerAdaptive&&this.canAdaptiveResolution)}}}setInstanceOptions(a){const b=this;return $jscomp.asyncExecutePromiseGeneratorFunction(function*(){var c=a.pid==b.options.pid&&a.iid==b.options.iid||
!a.pid&&a.iid==b.options.iid||!a.iid&&a.pid==b.options.pid;if(c&&!a.reset)b.api.log("setInstanceOptions: no change.");else{if(!c){c=(!a.iid||a.iid==b.options.iid)&&a.pid!=b.options.pid;if(b.streamerLocked&&c){b.api.log(H.getString("CannotChangeProject"));return}c=yield b.signallingConnection.checkParams(a);if(null!==c){if(!1===c.iid){b.api.log(`iid(${a.iid})${H.getString("InstanceNotExist")}`);return}if(!1===c.pid){b.api.log(`pid(${a.pid})${H.getString("ProjectNotExist")}`);return}}}b.destroy();b.options.iid=
a.iid;b.options.pid=a.pid;b.options.reset=a.reset;b.constructUrlAndConnect()}})}set fullscreen(a){a?R.fullscreen(this.container):R.exitFullscreen()}get fullscreen(){return!!document.fullscreenElement}setActionEventEnabled(a){let b;null==(b=this.htmlVideo)||b.setActionEventEnabled(a)}perfTest(a){let b;null==(b=this.rtc)||b.perfTest(a)}onApiReady(){this.setStatus(U.OnReady);let a;null==(a=this.signallingConnection)||a.sendReady();1==this.options.ui.mainUI?this.api.settings.setMainUIVisibility(!0):0==
this.options.ui.mainUI&&this.api.settings.setMainUIVisibility(!1);1==this.options.ui.campass?this.api.settings.setCampassVisible(!0):0==this.options.ui.campass&&this.api.settings.setCampassVisible(!1)}sendApi(a,b){if(a)if(b){let c;null==(c=this.signallingConnection)||c.sendApi(a)}else{let c;null==(c=this.rtc)||c.sendApi(a)}}onMainThreadBusy(a){if(1===a.busy){let b="BUSY! ",c=this.api.apiQueue.queueSize(),e=this.api.apiQueue.dataSize();0<c&&(b+=`${H.getString("JSQueue")}${c}/${e}\uff0c`);1<a.taskCount&&
(b+=`${H.getString("BackQueue")}${a.taskCount}\uff0c`);b+=`${H.getString("Execting")}${p[a.currentTask]}${H.getString("PleaseWait")}`;this.hasVideo&&(this.htmlVideo.isVideoLoaded()&&this.options.ui.taskListBar||!this.htmlVideo.isVideoLoaded())&&this.taskListBar.updateText(b)}else this.taskListBar.hide()}viewHome(a){this.api.viewHome(a)}resetInteractTimestamp(){let a=Date.now();this.timeOfLastInteraction=a;let b;null==(b=this.signallingConnection)||b.resetInteractTimestamp(a)}receiveParamInfo(a){this.paramInfo=
...
[`${H.getString("NodeInfo")}`];e&&this.nodeInfoArray.push(`\t${H.getString("Host")}`+e);c&&this.nodeInfoArray.push(`\t${H.getString("HostAddress")}`+c);b&&this.nodeInfoArray.push(`\t\u3000${H.getString("Project")}`+b);this.options.pid&&this.nodeInfoArray.push(`\t${H.getString("ProjectId")}`+this.options.pid);this.nodeInfoArray.push(`\t${H.getString("IID")}`+this.options.iid);this.nodeInfoArray.push(`\t${H.getString("Adaptive")}`+this.streamerAdaptive);this.nodeInfoArray.push(`\t${H.getString("LimitMaxRes")}`+
this.streamerLimitMaxResolution);this.nodeInfoArray.push(`\t${H.getString("Resolution")}${this.streamerResX}x${this.streamerResY}`);let d;null==(d=this.liveStatus)||d.updateButtonTip(this.nodeInfoArray.join("\n"));this.api.log(this.nodeInfoArray.join("\n\t"))}logStartupInfo(a){if(a){a=`[${ta()}] ${a}`;var b;null==(b=this.startupInfo)||b.log(a);1<wa&&(a=`[${this.uniqueId}] `+a);console.log("[DEBUG]"+a);this.api.log(a)}}setStatus(a,b){this.cloudStatus=a;let c;null==(c=this.statusIndicator)||c.setStatus(a);
switch(a){case U.WS_Disconnected:if(this.isDestroyed){console.log("destroyed.");break}b&&(this.logStartupInfo(b),console.warn(b));break;case U.WS_Connecting:this.logStartupInfo(`connecting with ${this.useHttps?"wss":"ws"}...`);break;case U.WS_Connected:this.logStartupInfo("connected");break;case U.OnReady:let e;null==(e=this.startupInfo)||e.hide();this.options.ui.debugEventsPanel&&!this.eventsPanel&&(this.eventsPanel=new dc(this),this.eventsPanel.appendText("Start recording events here:"))}}createWidgetsInConstructor(){this.taskListBar=
new kc(this);this.htmlVideo=new fc(this,{keyEventTarget:this.options.keyEventTarget,useBuiltinCursors:this.options.useBuiltinCursors,mouseKeyListener:this.options.events.mouseKeyListener,touchListener:this.options.events.touchListener,onEvents:a=>{let b;return null==(b=this.eventsPanel)?void 0:b.appendText(a)},onVideoLoaded:()=>{this.logStartupInfo("video: loadedmetadata");this.createWidgets();this.callEvent("onVideoLoaded");this.resize()},onMButtonDoubleClick:(a,b)=>{let c;null==(c=this.liveStatus)||
c.setPanelVisible(a,b)}});this.options.ui.statusIndicator&&(this.statusIndicator=new ic(this));this.options.ui.startupInfo&&(this.startupInfo=new hc(this),this.logStartupInfo("sdk version: "+this.api.getVersion()),this.logStartupInfo("uniqueId: "+this.uniqueId));this.options.disableResizeObserver||R.isMobileDevice||(this.resizeObserver=new ResizeObserver(Ia(()=>this.resize(),1E3)),this.resizeObserver.observe(this.container))}createWidgets(){this.options.ui.statusButton&&(this.liveStatus=new gc(this,
this.playerCount,this.nodeInfoArray.join("\n")));this.options.ui.fullscreenButton&&(this.fullscreenButton=new ec(this));this.options.ui.homeButton&&(this.homeButton=new lc(this));this.taskListBar&&this.taskListBar.setMode(1)}destroyWidgets(){this.liveStatus&&(this.liveStatus.destroy(),this.liveStatus=null);this.fullscreenButton&&(this.fullscreenButton.destroy(),this.fullscreenButton=null);this.homeButton&&(this.homeButton.destroy(),this.homeButton=null);this.eventsPanel&&(this.eventsPanel.destroy(),
this.eventsPanel=null);this.taskListBar&&(this.taskListBar.destroy(),this.taskListBar=null)}isQualityController(){return this.bQualityController}initWebRtcPlayer(a){H.setLanguage(a.language);this.rtc=new cc({useStats:this.hasVideo&&(this.options.ui.statusButton||this.options.events.onRtcStatsReport),peerConnectionOptions:a.peerConnectionOptions,events:{onlog:b=>this.logStartupInfo(b),ontrack:b=>{let c;null==(c=this.htmlVideo)||c.setTrack(b)},onicecandidate:b=>{let c;return null==(c=this.signallingConnection)?
void 0:c.sendCandidate(b)},onOfferCreated:b=>{let c;return null==(c=this.signallingConnection)?void 0:c.sendOffer(b.sdp,this.hasVideo)},onAnswerCreated:b=>{let c;return null==(c=this.signallingConnection)?void 0:c.send(b)},onstats:b=>{let c;null==(c=this.liveStatus)||c.updateWebRtcStats(b);this.callEvent("onRtcStatsReport",b)},ondatachannelopen:()=>{this.setStatus(U.RTC_Opened);this.signallingConnection.sendCustomString(this.options.customString);this.hasVideo&&(this.rtc.requestQualityControl(),this.liveStatus&&
this.rtc.requestInitialSettings());this.receiveRenderEvents||this.rtc.sendEnableReceiveEvents(!1);this.api.onConnectionOpen()},ondatachannelclose:b=>this.api.onConnectionClose(b),ondatachannelerror:b=>this.api.onConnectionClose(b.error),ondatachannelmessage:(b,c)=>{switch(b){case "ResponseAPI":this.api.onConnectionMessage(c);break;case "InitialSettings":let e;null==(e=this.liveStatus)||e.updateInitialSettings(c);break;case "VideoEncoderAvgQP":let d;if(null==(d=this.liveStatus)?0:d.visible)b=(new TextDecoder("utf-16")).decode(c.data.slice(1)),
...
WhiteSmoke:"RGB(245,245,245)",Gainsboro:"RGB(220,220,220)",LightGrey:"RGB(211,211,211)",Silver:"RGB(192,192,192)",DarkGray:"RGB(169,169,169)",Gray:"RGB(128,128,128)",DimGray:"RGB(105,105,105)",Black:"RGB(0,0,0)"};v.CommandType=p;v.CustomObjectData=cb;v.CustomObjectData2=db;v.CustomTagData=Qa;v.DecalData=ab;v.DigitalTwinAPI=sa;v.DigitalTwinPlayer=mc;v.DynamicWaterData=fb;v.FieldType={String:0,Number:1};v.HeatMapPointData=Na;v.HeatMapStyle={Normal:-1,CustomColor:0,CustomWave:1};v.HighlightAreaData=
Ra;v.ImageButtonData=Sa;v.LayerVisibleData=Ma;v.MapMode={Campass:0,SmallMap:1,BigMap:2};v.MeasurementMode={Coordinate:1,Linear:2,Horizontal:3,Vertical:4,MultiPoint:5,TerrainArea:6};v.MousePickMask=ra;v.ODLineData=Ya;v.PanelType={ViewshedAnalysis:0,SkylineAnalysis:1,ViewDomeAnalysis:2,VisiblityAnalysis:3,FloodFillAnalysis:4,SolarAnalysis:5,CutFillAnalysis:6,TerrainSlopeAnalysi:7,ContourLineAnalysis:8};v.PanoramaData=$a;v.Polygon3DData=Wa;v.Polygon3DStyle={Wave:0,LoopLine:1,Gradual:2,DynamicGradual:3,
WaveTransparent:4,WideWave:5,RotateArrow:6,RotateLine:7,RotateGradual:8,SingleColor:9,SingleColorWithLight:10,OriginColor:11};v.PolygonData=Za;v.PolygonStyle={SingleColor:0,CirclePoint:1,Volumn:2,Gradual:3,DynamicGradual:4,WaveTransparent:5,WideWave:6,RotateArrow:7,RotateLine:8,RotateGradual:9,OnTerrain:10,OriginColor:11};v.PolylineData=Xa;v.PolylineStyle={Arrow:0,Arrow1:1,Flow:2,Beam:3,Normal:4,OnTerrain:5,DottedNormal:6,DottedCircle:7,OriginColor:8};v.REVISION=17225;v.RadiationPointData=Va;v.RendererType=
{SimpleRenderer:0,UniqueValueRenderer:1,ClassBreaksRenderer:2};v.ResetType=Aa;v.TagData=Oa;v.TileLayerActorData=fa;v.TileLayerData=bb;v.VERSION="6.0";v.VehicleViewMode={FirstPerson:0,ThirdPerson:1};v.VideoProjectionData=eb;v.Viewport=ba;v.VisualType={Color:0,Size:1,Height:1,Opacity:1};v.WaterFlowFieldStyle={HeatMap:0,Water:1,Particle:2};v.WebUIData=Pa;v.__onCefResponse=function(a,b){if(va)va.onConnectionMessage(a,b)};Object.defineProperty(v,"__esModule",{value:!0});return v}({});
